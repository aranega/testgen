...
import com.genmymodel.petshop.entity.criteria.OrderCriteriaInstance;
...
public class OrderCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	private ObjectProperty<com.genmymodel.petshop.entity.OrderStatus> statusProperty;
	 ...
	 * Handled Criteria
	 */
	private OrderCriteriaInstance orderCriteria;

	/*
	 * Constructors
	 * <!-- Start of user code comment for OrderCriteria constructor
	 * End of user code -->
	 */
	public OrderCriteria(){
		this(new OrderCriteriaInstance());
	...
	/*
	 * Constructors
	 * <!-- Start of user code comment for OrderCriteria constructor with parameters
	 * End of user code -->
	 */
	public OrderCriteria(OrderCriteriaInstance entity) {
		...
		this.orderCriteria = entity;
		//Start of user code constructor with parameters
		//End of user code
	}
	
	public OrderCriteriaInstance getOrderCriteriaInstance(){
		return this.orderCriteria;
	}
	
	
	public OrderCriteriaInstance getBean() {
		return  this.orderCriteria;
	}
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			creationDateMaxProperty = new SimpleObjectProperty<java.util.Date>(orderCriteria.getCreationDateMax());
			creationDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					orderCriteria.setCreationDateMax(arg2);
				}
			});
	...
	public void setCreationDateMax(java.util.Date myCreationDateMax){
		if (creationDateMaxProperty == null) {
				orderCriteria.setCreationDateMax(myCreationDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			creationDateMinProperty = new SimpleObjectProperty<java.util.Date>(orderCriteria.getCreationDateMin());
			creationDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					orderCriteria.setCreationDateMin(arg2);
				}
			});
	...
	public void setCreationDateMin(java.util.Date myCreationDateMin){
		if (creationDateMinProperty == null) {
				orderCriteria.setCreationDateMin(myCreationDateMin);
			} else {
	...
	public StringProperty dateProperty(){
		if (this.dateProperty == null) {
			this.dateProperty = new SimpleStringProperty(orderCriteria.getDate());
			this.dateProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					orderCriteria.setDate((String) arg2);
				}
			});
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			this.idMaxProperty = new SimpleLongProperty(orderCriteria.getIdMax());
			this.idMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					orderCriteria.setIdMax((Long) arg2);
				}
			});
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			this.idMinProperty = new SimpleLongProperty(orderCriteria.getIdMin());
			this.idMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					orderCriteria.setIdMin((Long) arg2);
				}
			});
	...
	public StringProperty referenceProperty(){
		if (this.referenceProperty == null) {
			this.referenceProperty = new SimpleStringProperty(orderCriteria.getReference());
			this.referenceProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					orderCriteria.setReference((String) arg2);
				}
			});
	 ...
	 * <!-- End of user code -->
	 */
	public ObjectProperty<com.genmymodel.petshop.entity.OrderStatus> statusProperty() {
		if (statusProperty == null) {
			statusProperty = new SimpleObjectProperty<com.genmymodel.petshop.entity.OrderStatus>(orderCriteria.getStatus());
			statusProperty.addListener(new ChangeListener<com.genmymodel.petshop.entity.OrderStatus>() {
				@Override
				public void changed(ObservableValue<? extends com.genmymodel.petshop.entity.OrderStatus> arg0, com.genmymodel.petshop.entity.OrderStatus arg1, com.genmymodel.petshop.entity.OrderStatus arg2) {
					orderCriteria.setStatus(arg2);
				}
			});
	 ...
	 * <!-- End of user code -->
	 */
	public void setStatus(com.genmymodel.petshop.entity.OrderStatus myStatus){
		if (statusProperty == null) {
				orderCriteria.setStatus(myStatus);
			} else {
				this.statusProperty().set(myStatus);
			}
	}
	
	public void updateStatus(final com.genmymodel.petshop.entity.OrderStatus myStatus, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setStatus(myStatus);
			if (mutex != null) {
				mutex.notify();
	...
	public void updateStatus(final com.genmymodel.petshop.entity.OrderStatus myStatus) {
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			updateDateMaxProperty = new SimpleObjectProperty<java.util.Date>(orderCriteria.getUpdateDateMax());
			updateDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					orderCriteria.setUpdateDateMax(arg2);
				}
			});
	...
	public void setUpdateDateMax(java.util.Date myUpdateDateMax){
		if (updateDateMaxProperty == null) {
				orderCriteria.setUpdateDateMax(myUpdateDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			updateDateMinProperty = new SimpleObjectProperty<java.util.Date>(orderCriteria.getUpdateDateMin());
			updateDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					orderCriteria.setUpdateDateMin(arg2);
				}
			});
	...
	public void setUpdateDateMin(java.util.Date myUpdateDateMin){
		if (updateDateMinProperty == null) {
				orderCriteria.setUpdateDateMin(myUpdateDateMin);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(orderCriteria.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					orderCriteria.setVersion((Integer) arg2);
				}
			});
