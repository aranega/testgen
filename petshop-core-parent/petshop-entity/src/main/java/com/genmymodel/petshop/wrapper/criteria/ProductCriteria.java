...
import com.genmymodel.petshop.entity.criteria.ProductCriteriaInstance;
...
public class ProductCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	 ...
	 * Handled Criteria
	 */
	private ProductCriteriaInstance productCriteria;

	/*
	 * Constructors
	 * <!-- Start of user code comment for ProductCriteria constructor
	 * End of user code -->
	 */
	public ProductCriteria(){
		this(new ProductCriteriaInstance());
	...
	/*
	 * Constructors
	 * <!-- Start of user code comment for ProductCriteria constructor with parameters
	 * End of user code -->
	 */
	public ProductCriteria(ProductCriteriaInstance entity) {
		...
		this.productCriteria = entity;
		//Start of user code constructor with parameters
		//End of user code
	}
	
	public ProductCriteriaInstance getProductCriteriaInstance(){
		return this.productCriteria;
	}
	
	
	public ProductCriteriaInstance getBean() {
		return  this.productCriteria;
	}
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			creationDateMaxProperty = new SimpleObjectProperty<java.util.Date>(productCriteria.getCreationDateMax());
			creationDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					productCriteria.setCreationDateMax(arg2);
				}
			});
	...
	public void setCreationDateMax(java.util.Date myCreationDateMax){
		if (creationDateMaxProperty == null) {
				productCriteria.setCreationDateMax(myCreationDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			creationDateMinProperty = new SimpleObjectProperty<java.util.Date>(productCriteria.getCreationDateMin());
			creationDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					productCriteria.setCreationDateMin(arg2);
				}
			});
	...
	public void setCreationDateMin(java.util.Date myCreationDateMin){
		if (creationDateMinProperty == null) {
				productCriteria.setCreationDateMin(myCreationDateMin);
			} else {
	...
	public StringProperty descriptionProperty(){
		if (this.descriptionProperty == null) {
			this.descriptionProperty = new SimpleStringProperty(productCriteria.getDescription());
			this.descriptionProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					productCriteria.setDescription((String) arg2);
				}
			});
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			this.idMaxProperty = new SimpleLongProperty(productCriteria.getIdMax());
			this.idMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					productCriteria.setIdMax((Long) arg2);
				}
			});
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			this.idMinProperty = new SimpleLongProperty(productCriteria.getIdMin());
			this.idMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					productCriteria.setIdMin((Long) arg2);
				}
			});
	...
	public StringProperty nameProperty(){
		if (this.nameProperty == null) {
			this.nameProperty = new SimpleStringProperty(productCriteria.getName());
			this.nameProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					productCriteria.setName((String) arg2);
				}
			});
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			updateDateMaxProperty = new SimpleObjectProperty<java.util.Date>(productCriteria.getUpdateDateMax());
			updateDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					productCriteria.setUpdateDateMax(arg2);
				}
			});
	...
	public void setUpdateDateMax(java.util.Date myUpdateDateMax){
		if (updateDateMaxProperty == null) {
				productCriteria.setUpdateDateMax(myUpdateDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			updateDateMinProperty = new SimpleObjectProperty<java.util.Date>(productCriteria.getUpdateDateMin());
			updateDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					productCriteria.setUpdateDateMin(arg2);
				}
			});
	...
	public void setUpdateDateMin(java.util.Date myUpdateDateMin){
		if (updateDateMinProperty == null) {
				productCriteria.setUpdateDateMin(myUpdateDateMin);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(productCriteria.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					productCriteria.setVersion((Integer) arg2);
				}
			});
