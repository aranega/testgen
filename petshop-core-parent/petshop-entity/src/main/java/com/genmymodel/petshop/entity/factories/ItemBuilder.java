...
// End of user code
{
	...
	public Item build() throws NullPointerException {
		...
		if (myAttributeIsBioutifoul == null) {
			handleDefaultMyAttributeIsBioutifoul(result);
		} else { 
			result.setMyAttributeIsBioutifoul(myAttributeIsBioutifoul);
		}
		if (price == null) {
	...
	/*
	 * <!-- Start of user code comment for myAttributeIsBioutifoul default method
	 * End of user code -->
	 */
	...
	/*
	 * <!-- Start of user code comment for myAttributeIsBioutifoul
	 * End of user code -->
	 */
