...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for Product wrapper getter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	@Override
	...
	/*
	 * <!-- Start of user code comment for Product wrapper setter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	public void setWrapper(Product wrapper) {
	...
	public Element toXML(){
		Element xmlElement = new Element("Product");
		if (uuid != null)
