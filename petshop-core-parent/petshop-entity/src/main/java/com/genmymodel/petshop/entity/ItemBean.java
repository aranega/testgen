...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for Item wrapper getter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	@Override
	...
	/*
	 * <!-- Start of user code comment for Item wrapper setter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	...
	/*
	 * <!-- Start of user code comment for product unsetter
	 * End of user code -->
	 */
	...
	public Element toXML(){
		Element xmlElement = new Element("Item");
		if (uuid != null)
			xmlElement.setAttribute(new Attribute("uuid", uuid));
		xmlElement.setAttribute(new Attribute("price", String.valueOf(getPrice())));
		if (getQuantity() != null)
			xmlElement.setAttribute(new Attribute("quantity", getQuantity()));
		if (getMyAttributeIsBioutifoul() != null)
			xmlElement.setAttribute(new Attribute("myAttributeIsBioutifoul", getMyAttributeIsBioutifoul()));
