...
// End of user code
{
	 ...
	 * @generated
	 */
	private void handleDefaultE(D result) throws NullPointerException {
		// result.setE(null);
	}
	 ...
	 * @generated
	 */
	private void handleDefaultIsOk(D result) {
		result.setIsOk(Boolean.valueOf(cfg.getProperty("defaultValue.D.isOk", "false")));
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public BUILDER isOk(Boolean myIsOk) {
		this.isOk = myIsOk;
		return (BUILDER) this;
	}
