...
//End of user code
{
	 ...
	 * The logger
 	 ...
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(DBean.class);
	 ...
	 * @generated
	 */
	@javax.persistence.OneToOne(optional = true, cascade = javax.persistence.CascadeType.ALL, mappedBy = "d")
	private EBean e;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 ...
	 */
	@javax.persistence.Transient
	public void setWrapper(D wrapper) {
