...
import com.dooapp.dooapptest.entity.criteria.BCriteriaInstance;
...
// End of user code
{
	 ...
	 * @generated
	 */
	private StringProperty myAttProperty;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			...
			bCriteria.setCreationDateMax(bCriteria.getCreationDateMax());
	...
	protected ObjectProperty<java.util.Date> createCreationDateMaxProperty(){
		return  new SimpleObjectProperty<java.util.Date>(bCriteria.getCreationDateMax());
	}
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			...
			bCriteria.setCreationDateMin(bCriteria.getCreationDateMin());
	...
	protected ObjectProperty<java.util.Date> createCreationDateMinProperty(){
		return  new SimpleObjectProperty<java.util.Date>(bCriteria.getCreationDateMin());
	}
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			...
			bCriteria.setIdMax(bCriteria.getIdMax());
	...
	protected LongProperty createIdMaxProperty(){
		return new SimpleLongProperty(bCriteria.getIdMax());
	}
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			...
			bCriteria.setIdMin(bCriteria.getIdMin());
	...
	protected LongProperty createIdMinProperty(){
		return new SimpleLongProperty(bCriteria.getIdMin());
	}
	 ...
	 * @generated
	 */
	public StringProperty myAttProperty(){
		if (this.myAttProperty == null) {
			this.myAttProperty = createMyAttProperty();
			bCriteria.setMyAtt(bCriteria.getMyAtt());
			this.myAttProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					bCriteria.setMyAtt((String) arg2);
				}
			});
		}
		return this.myAttProperty;
	}
	 ...
	 * @generated
	 */
	protected StringProperty createMyAttProperty(){
		return new SimpleStringProperty(bCriteria.getMyAtt());
	}
	 ...
	 * @generated
	 */
	public void setMyAtt(String myMyAtt){
		this.myAttProperty().set(myMyAtt);
	}
	 ...
	 * @generated
	 */
	public void updateMyAtt(final String myMyAtt) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setMyAtt(myMyAtt);
		} else {
			javafx.application.Platform.runLater(new Runnable() {
	 ...
	 * @generated
	 */
	public void updateMyAttAndWait(final String myMyAtt) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setMyAtt(myMyAtt);
		} else {
			final Object mutex = new Object();
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			...
			bCriteria.setUpdateDateMax(bCriteria.getUpdateDateMax());
	...
	protected ObjectProperty<java.util.Date> createUpdateDateMaxProperty(){
		return  new SimpleObjectProperty<java.util.Date>(bCriteria.getUpdateDateMax());
	}
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			...
			bCriteria.setUpdateDateMin(bCriteria.getUpdateDateMin());
	...
	protected ObjectProperty<java.util.Date> createUpdateDateMinProperty(){
		return  new SimpleObjectProperty<java.util.Date>(bCriteria.getUpdateDateMin());
	}
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			...
			bCriteria.setVersion(bCriteria.getVersion());
	...
	protected IntegerProperty createVersionProperty(){
		return new SimpleIntegerProperty(bCriteria.getVersion());
	}
