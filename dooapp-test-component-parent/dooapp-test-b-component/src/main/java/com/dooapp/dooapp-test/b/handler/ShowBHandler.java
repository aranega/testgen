package com.dooapp.dooapp-test.b.handler;
...
import com.dooapp.dooapp-test.b.controller.BController;
 ...
 * @generated
 */
public class ShowBHandler extends AbstractDisplayHandler<B>  {
	/**
	 * The logger
	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	 * @generated
	 */
	private static final Logger logger = LoggerFactory.getLogger(ShowBHandler.class);
	/**
	...
	private Executor fx;
	/**
	 * The entity manager to get a fresh instance of B
 	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	 * @generated
	 */
	 ...
	 */
	@Inject
	private BController itemController;
	/**
	 * The context
 	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	...
	@Inject
	@Context
	private ObjectProperty<B> context;
	 ...
	 */
	@Override
	protected B loadDataInBackground(LinkEvent<DisplayLocation> arg0) {
		try {
			return entityManager.get(B.class, arg0.getLocation().getId());
	 ...
	 */
	@Override
	protected void toStore(B configuration, ObservableList<Wrapper> toStore) {
	 ...
	 */
	@Override
	protected void configureLocation(final B item, ObservableList<MenuItem> items) {
		items.clear();
		...
		MenuItem currentItem = MenuItemBuilder.create()
				.onAction(ApplicationDomain.B.showHandler(B.class, item.getId())).build();
	 ...
	 */
	@Override
	protected void configureContext(final B item) {
		context.set(item);
	}
}
