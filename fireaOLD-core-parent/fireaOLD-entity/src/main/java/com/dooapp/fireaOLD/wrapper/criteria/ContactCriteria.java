...
import com.dooapp.fireaOLD.entity.criteria.ContactCriteriaInstance;
...
public class ContactCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	public ObjectProperty<com.dooapp.fireaOLD.entity.ContactKind> kindProperty() {
		if (kindProperty == null) {
			kindProperty = new SimpleObjectProperty<com.dooapp.fireaOLD.entity.ContactKind>(contactCriteria.getKind());
