...
import com.dooapp.fireaOLD.entity.ContactKind;
...
public class ContactBuilder<BUILDER extends ContactBuilder<?>>
{
	...
	private void handleDefaultImage(Contact result) {
		...
		result.setImage(persistentImageBuilder.contact(result).build());
		//End of user code
	}
	 ...
	 * End of user code -->
	 */
	public BUILDER kind(com.dooapp.fireaOLD.entity.ContactKind myKind) {
			this.kind = myKind;
			return (BUILDER) this;
	}
