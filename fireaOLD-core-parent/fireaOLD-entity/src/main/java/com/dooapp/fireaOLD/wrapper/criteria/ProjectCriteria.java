...
import com.dooapp.fireaOLD.entity.criteria.ProjectCriteriaInstance;
...
public class ProjectCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	private ObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind> statusProperty;
	...
	private ObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind> kindProperty;
	 ...
	 * <!-- End of user code -->
	 */
	public ObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind> statusProperty() {
		if (statusProperty == null) {
			statusProperty = new SimpleObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind>(projectCriteria.getStatus());
			statusProperty.addListener(new ChangeListener<com.dooapp.fireaOLD.entity.ProjectKind>() {
				@Override
				public void changed(ObservableValue<? extends com.dooapp.fireaOLD.entity.ProjectKind> arg0, com.dooapp.fireaOLD.entity.ProjectKind arg1, com.dooapp.fireaOLD.entity.ProjectKind arg2) {
	 ...
	 * <!-- End of user code -->
	 */
	public void setStatus(com.dooapp.fireaOLD.entity.ProjectKind myStatus){
		if (statusProperty == null) {
	...
	public void updateStatus(final com.dooapp.fireaOLD.entity.ProjectKind myStatus, final Object mutex) {
	...
	public void updateStatus(final com.dooapp.fireaOLD.entity.ProjectKind myStatus) {
	 ...
	 * <!-- End of user code -->
	 */
	public ObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind> kindProperty() {
		if (kindProperty == null) {
			kindProperty = new SimpleObjectProperty<com.dooapp.fireaOLD.entity.ProjectKind>(projectCriteria.getKind());
			kindProperty.addListener(new ChangeListener<com.dooapp.fireaOLD.entity.ProjectKind>() {
				@Override
				public void changed(ObservableValue<? extends com.dooapp.fireaOLD.entity.ProjectKind> arg0, com.dooapp.fireaOLD.entity.ProjectKind arg1, com.dooapp.fireaOLD.entity.ProjectKind arg2) {
	 ...
	 * <!-- End of user code -->
	 */
	public void setKind(com.dooapp.fireaOLD.entity.ProjectKind myKind){
		if (kindProperty == null) {
	...
	public void updateKind(final com.dooapp.fireaOLD.entity.ProjectKind myKind, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setKind(myKind);
			if (mutex != null) {
				mutex.notify();
	...
	public void updateKind(final com.dooapp.fireaOLD.entity.ProjectKind myKind) {
