...
import com.dooapp.fireaOLD.wrapper.criteria.PersistentImageDataCriteria;
...
public class PersistentImageDataCriteriaInstance implements Bean
{
	...
	/*
	 * <!-- Start of user code comment for PersistentImageDataCriteria wrapper getter
	 * End of user code -->
	 */
	...
	/*
	 * <!-- Start of user code comment for PersistentImageDataCriteria wrapper setter
	 * End of user code -->
	 */
