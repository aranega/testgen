...
import com.dooapp.fireaOLD.wrapper.criteria.PointCriteria;
...
public class PointCriteriaInstance implements Bean
{
	...
	/*
	 * <!-- Start of user code comment for PointCriteria wrapper getter
	 * End of user code -->
	 */
	...
	/*
	 * <!-- Start of user code comment for PointCriteria wrapper setter
	 * End of user code -->
	 */
