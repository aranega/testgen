...
import com.dooapp.fireaOLD.entity.criteria.StepCriteriaInstance;
...
public class StepCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	private ObjectProperty<com.dooapp.fireaOLD.entity.StepStatus> statusProperty;
	 ...
	 * <!-- End of user code -->
	 */
	public ObjectProperty<com.dooapp.fireaOLD.entity.StepStatus> statusProperty() {
		if (statusProperty == null) {
			statusProperty = new SimpleObjectProperty<com.dooapp.fireaOLD.entity.StepStatus>(stepCriteria.getStatus());
			statusProperty.addListener(new ChangeListener<com.dooapp.fireaOLD.entity.StepStatus>() {
				@Override
				public void changed(ObservableValue<? extends com.dooapp.fireaOLD.entity.StepStatus> arg0, com.dooapp.fireaOLD.entity.StepStatus arg1, com.dooapp.fireaOLD.entity.StepStatus arg2) {
	 ...
	 * <!-- End of user code -->
	 */
	public com.dooapp.fireaOLD.entity.StepStatus getStatus(){
	 ...
	 * <!-- End of user code -->
	 */
	public void setStatus(com.dooapp.fireaOLD.entity.StepStatus myStatus){
		if (statusProperty == null) {
	...
	public void updateStatus(final com.dooapp.fireaOLD.entity.StepStatus myStatus, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setStatus(myStatus);
			if (mutex != null) {
				mutex.notify();
	...
	public void updateStatus(final com.dooapp.fireaOLD.entity.StepStatus myStatus) {
