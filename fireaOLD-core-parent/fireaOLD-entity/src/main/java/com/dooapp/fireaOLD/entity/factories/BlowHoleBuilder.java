...
import com.dooapp.fireaOLD.wrapper.TestedRoom;
import com.dooapp.fireaOLD.entity.Discharge;
...
public class BlowHoleBuilder<BUILDER extends BlowHoleBuilder<?>>
{
	 ...
	 * End of user code -->
	 */
	public BUILDER Discharge(com.dooapp.fireaOLD.entity.Discharge myDischarge) {
