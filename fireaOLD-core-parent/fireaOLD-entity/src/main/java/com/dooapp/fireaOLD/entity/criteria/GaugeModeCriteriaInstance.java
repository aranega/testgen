...
import com.dooapp.fireaOLD.wrapper.criteria.GaugeModeCriteria;
...
public class GaugeModeCriteriaInstance implements Bean
{
	...
	/*
	 * <!-- Start of user code comment for GaugeModeCriteria wrapper getter
	 * End of user code -->
	 */
	...
	/*
	 * <!-- Start of user code comment for GaugeModeCriteria wrapper setter
	 * End of user code -->
	 */
