...
import com.dooapp.fireaOLD.entity.criteria.BottleConfigurationCriteriaInstance;
...
public class BottleConfigurationCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	private ObjectProperty<com.dooapp.fireaOLD.entity.BottleUnit> unitProperty;
	 ...
	 * <!-- End of user code -->
	 */
	public ObjectProperty<com.dooapp.fireaOLD.entity.BottleUnit> unitProperty() {
		if (unitProperty == null) {
			unitProperty = new SimpleObjectProperty<com.dooapp.fireaOLD.entity.BottleUnit>(bottleConfigurationCriteria.getUnit());
			unitProperty.addListener(new ChangeListener<com.dooapp.fireaOLD.entity.BottleUnit>() {
				@Override
				public void changed(ObservableValue<? extends com.dooapp.fireaOLD.entity.BottleUnit> arg0, com.dooapp.fireaOLD.entity.BottleUnit arg1, com.dooapp.fireaOLD.entity.BottleUnit arg2) {
	 ...
	 * <!-- End of user code -->
	 */
	public com.dooapp.fireaOLD.entity.BottleUnit getUnit(){
	 ...
	 * <!-- End of user code -->
	 */
	public void setUnit(com.dooapp.fireaOLD.entity.BottleUnit myUnit){
		if (unitProperty == null) {
	...
	public void updateUnit(final com.dooapp.fireaOLD.entity.BottleUnit myUnit, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setUnit(myUnit);
			if (mutex != null) {
				mutex.notify();
	...
	public void updateUnit(final com.dooapp.fireaOLD.entity.BottleUnit myUnit) {
