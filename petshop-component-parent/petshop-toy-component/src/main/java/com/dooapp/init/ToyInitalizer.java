...
/**
 * This class init the Toy module<br>
 * <br>
 * Created at : 1360941107<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class ToyInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(ToyInitalizer.class);
