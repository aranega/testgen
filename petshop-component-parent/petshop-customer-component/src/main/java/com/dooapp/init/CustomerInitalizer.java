...
/**
 * This class init the Customer module<br>
 * <br>
 * Created at : 1358346772<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class CustomerInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(CustomerInitalizer.class);
