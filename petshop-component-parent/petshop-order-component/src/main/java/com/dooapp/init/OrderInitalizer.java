...
/**
 * This class init the Order module<br>
 * <br>
 * Created at : 1358346782<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class OrderInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(OrderInitalizer.class);
