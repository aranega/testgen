...
import com.dooapp.ioc.CartModule;
 ...
 */
@Ignore
public class CartControllerTest extends Application {
	/**
	 * The logger
	 */
	...
	public void start(Stage arg0) throws Exception {
		...
		Scene scene = new Scene((Parent) injector.getInstance(CartController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
