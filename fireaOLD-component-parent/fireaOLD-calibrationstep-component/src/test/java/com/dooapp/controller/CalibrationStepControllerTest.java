...
public class CalibrationStepControllerTest extends Application {
	...
	public void start(Stage arg0) throws Exception {
		Injector injector = Guice.createInjector(new CalibrationStepModule());
		Scene scene = new Scene((Parent) injector.getInstance(CalibrationStepController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
