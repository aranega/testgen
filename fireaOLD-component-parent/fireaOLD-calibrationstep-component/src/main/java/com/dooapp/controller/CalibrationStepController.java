...
import fireaOLD.wrapper.CalibrationStep;
...
public class CalibrationStepController extends AbstractController<Node> implements javafx.fxml.Initializable 
{
	...
	@javafx.fxml.FXML
	private ComboBox<org.eclipse.emf.ecore.impl.DynamicEObjectImpl@6ae1772b (eClass: org.eclipse.emf.ecore.impl.EClassImpl@7856dede (name: OclInvalid_Class) (instanceClassName: null) (abstract: false, interface: false))> points_data;
	@javafx.fxml.FXML
	private TableView<org.eclipse.emf.ecore.impl.DynamicEObjectImpl@6ae1772b (eClass: org.eclipse.emf.ecore.impl.EClassImpl@7856dede (name: OclInvalid_Class) (instanceClassName: null) (abstract: false, interface: false))> points_dataview;
	@javafx.fxml.FXML
	private ComboBox<org.eclipse.emf.ecore.impl.DynamicEObjectImpl@6ae1772b (eClass: org.eclipse.emf.ecore.impl.EClassImpl@7856dede (name: OclInvalid_Class) (instanceClassName: null) (abstract: false, interface: false))> sample_data;
	@javafx.fxml.FXML
	private ComboBox<org.eclipse.emf.ecore.impl.DynamicEObjectImpl@6ae1772b (eClass: org.eclipse.emf.ecore.impl.EClassImpl@7856dede (name: OclInvalid_Class) (instanceClassName: null) (abstract: false, interface: false))> status_data;
	@javafx.fxml.FXML
