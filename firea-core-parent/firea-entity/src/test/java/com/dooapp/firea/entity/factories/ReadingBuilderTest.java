...
{	
	 ...
	 */
	@Test
	public void refSetterGaugemodeClassicTest() throws Exception {
		Reading unsavedReading =  readingBuilder.build();
		Reading savedReading = manager.save(unsavedReading);
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
	...
	public void refSetterDeviceTest() throws Exception {	
		...
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
		Assert.assertNotNull(dbReading.getDevice());
	}
	 ...
	 */
	@Test
	public void refSetterDeviceClassicTest() throws Exception {
		Reading unsavedReading =  readingBuilder.build();
		Reading savedReading = manager.save(unsavedReading);
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
	 ...
	 */
	@Test
	public void refSetterPointClassicTest() throws Exception {
		Reading unsavedReading =  readingBuilder.build();
		Reading savedReading = manager.save(unsavedReading);
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
	...
	public void oppositePointTest() throws Exception {
		...
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
		Assert.assertNotNull(dbReading.getPoint().getReadings());
		Assert.assertEquals(dbReading, dbReading.getPoint().getReadings());
	}
	 ...
	 */
	@Test
	public void oppositePointClassicTest() throws Exception {
		Reading unsavedReading =  readingBuilder.build();
		Reading savedReading = manager.save(unsavedReading);
		Reading dbReading = manager.get(Reading.class, savedReading.getId());
		Assert.assertNotNull(dbReading);
