 ...
 * @generated
 */
public class GaugeModeBeanTest
{
	/**
 	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	...
	public void setAndGetGaugeType() {
		String tmp = "";
		this.bean.setGaugeType(tmp);
		String result = this.bean.getGaugeType();
	...
	/*******************
	 * Methods owned by GaugeModeBean
	 *******************/
