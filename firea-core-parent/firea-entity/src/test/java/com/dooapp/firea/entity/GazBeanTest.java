...
import java.util.List;import com.dooapp.firea.enumeration.GazWeight;
...
public class GazBeanTest
{
	...
	public void setAndGetWeight() {
		...
		GazWeight result = this.bean.getWeight();
	...
	public void setAndGetType() {
		...
		Integer result = this.bean.getType();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetBottletypes() {
		...
		this.bean.addBottletypes(tmp);
		List<BottleTypeBean> result = this.bean.getBottletypes();
