...
public class PersistentImageBeanTest
{
	...
	public void setAndGetPreview() {
		String tmp = "";
		this.bean.setPreview(tmp);
		String result = this.bean.getPreview();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetContact() {
		...
		this.bean.setContact(tmp);
		ContactBean result = this.bean.getContact();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	...
	/*******************
	 * Methods owned by PersistentImageBean
	 *******************/
