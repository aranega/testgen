...
public class TestedRoomTest
{
	...
	public void setAndGetClimVMCAuto() {
		...
		String result = this.wrapper.getClimVMCAuto();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
		//End of user code
	}
	...
	public void setAndGetBlowholes() {
		...
		this.wrapper.setBlowholes(tmp);
		BlowHole result = this.wrapper.getBlowholes();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
		//End of user code
	}
	 ...
	 */
	@Test
	public void oppositeBlowholesTest() {
		//Start of user code basic opposite test for blowholes reference
		BlowHole elem1 = new BlowHole();
		this.wrapper.setBlowholes(elem1);
		//TestedRoom elem2 = elem1.getTestedroom();
		TestedRoom elem2 = elem1.getTestedroom();
