 ...
 * @generated
 */
public class PersistentImageDataTest
{
	/**
	 * @generated
	 */
	...
	@Before
	public void setup(){
		this.wrapper = (new PersistentImageDataBean()).getWrapper();
	}
	...
	public void setAndGetData() {
		String tmp = "";
		this.wrapper.setData(tmp);
		String result = this.wrapper.getData();
	...
	/*******************
	 * Methods owned by PersistentImageData
	 *******************/
