...
public class PointTest
{
	...
	public void setAndGetDeltaPm() {
		Double tmp = 0.0;
		this.wrapper.setDeltaPm(tmp);
		Double result = this.wrapper.getDeltaPm();
	...
	public void setAndGetStatus() {
		...
		PointStatus result = this.wrapper.getStatus();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetEla() {
		Double tmp = 0.0;
		this.wrapper.setEla(tmp);
		Double result = this.wrapper.getEla();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetVl() {
		Double tmp = 0.0;
		this.wrapper.setVl(tmp);
		Double result = this.wrapper.getVl();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
