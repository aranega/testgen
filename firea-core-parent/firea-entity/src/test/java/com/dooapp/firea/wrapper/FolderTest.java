...
public class FolderTest
{
	 ...
	 */
	@Test
	public void setAndGetDisplayOrder() {
		//Start of user code basic set and get for displayOrder attribute
		Integer tmp = 0;
		this.wrapper.setDisplayOrder(tmp);
		Integer result = this.wrapper.getDisplayOrder();
