...
{	
	 ...
	 */
	@Test
	public void setterNGetterBoundInitialConcentration() throws Exception {
		GazConfiguration unsavedGazConfiguration = gazConfigurationBuilder.boundInitialConcentration(false).build();
		GazConfiguration savedGazConfiguration = manager.save(unsavedGazConfiguration);
		GazConfiguration dbGazConfiguration = manager.get(GazConfiguration.class, savedGazConfiguration.getId());
		Assert.assertNotNull(dbGazConfiguration.isBoundInitialConcentration());
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
