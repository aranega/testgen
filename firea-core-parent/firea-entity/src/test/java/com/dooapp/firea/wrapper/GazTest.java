...
public class GazTest
{
	...
	public void setAndGetType() {
		...
		String result = this.wrapper.getType();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetWeight() {
		...
		GazWeight result = this.wrapper.getWeight();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	 ...
	 */
	@Test
	public void setAndGetLoaelConcentration() {
		Double tmp = 0.0;
		this.wrapper.setLoaelConcentration(tmp);
		Double result = this.wrapper.getLoaelConcentration();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
