 ...
 * @generated
 */
public class CalibrationStepBeanTest
{
	/**
 	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	 ...
	 */
	@Test
	public void setAndGetHoleSize() {
		Double tmp = 0.0;
		this.bean.setHoleSize(tmp);
		Double result = this.bean.getHoleSize();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	/*******************
	 * Methods owned by CalibrationStepBean
	 *******************/
