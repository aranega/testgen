...
{	
	...
	public void refSetterBottleconfigurationTest() throws Exception {	
		...
		BottleType dbBottleType = manager.get(BottleType.class, savedBottleType.getId());
		Assert.assertNotNull(dbBottleType);
		Assert.assertNotNull(dbBottleType.getBottleconfiguration());
	}
	 ...
	 */
	@Test
	public void refSetterBottleconfigurationClassicTest() throws Exception {
		BottleType unsavedBottleType =  bottleTypeBuilder.build();
		BottleType savedBottleType = manager.save(unsavedBottleType);
		BottleType dbBottleType = manager.get(BottleType.class, savedBottleType.getId());
		Assert.assertNotNull(dbBottleType);
	...
	public void oppositeBottleconfigurationTest() throws Exception {
		...
		BottleType dbBottleType = manager.get(BottleType.class, savedBottleType.getId());
		Assert.assertNotNull(dbBottleType);
		Assert.assertNotNull(dbBottleType.getBottleconfiguration().getBottletype());
		Assert.assertEquals(dbBottleType, dbBottleType.getBottleconfiguration().getBottletype());
	}
	 ...
	 */
	@Test
	public void oppositeBottleconfigurationClassicTest() throws Exception {
		BottleType unsavedBottleType =  bottleTypeBuilder.build();
		BottleType savedBottleType = manager.save(unsavedBottleType);
		BottleType dbBottleType = manager.get(BottleType.class, savedBottleType.getId());
		Assert.assertNotNull(dbBottleType);
