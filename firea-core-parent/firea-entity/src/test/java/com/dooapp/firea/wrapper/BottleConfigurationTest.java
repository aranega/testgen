...
public class BottleConfigurationTest
{
	...
	public void oppositeGazconfigurationTest() {
		...
		//BottleConfiguration elem2 = elem1.getBottleconfigurations();
		BottleConfiguration elem2 = elem1.getBottleconfigurations();
	...
	@Test
	public void oppositeBottletypeTest() {
		//Start of user code basic opposite test for bottletype reference
		BottleType elem1 = new BottleType();
		this.wrapper.setBottletype(elem1);
		//BottleConfiguration elem2 = elem1.getBottleconfiguration();
		BottleConfiguration elem2 = elem1.getBottleconfiguration();
		Assert.assertNotNull(elem2);
		Assert.assertEquals(elem1, elem2);
		//End of user code
