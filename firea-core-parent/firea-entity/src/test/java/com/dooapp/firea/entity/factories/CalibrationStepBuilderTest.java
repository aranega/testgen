...
{	
	 ...
	 */
	@Test
	public void setterNGetterHoleSize() throws Exception {
		CalibrationStep unsavedCalibrationStep = calibrationStepBuilder.holeSize(0.0).build();
		CalibrationStep savedCalibrationStep = manager.save(unsavedCalibrationStep);
		CalibrationStep dbCalibrationStep = manager.get(CalibrationStep.class, savedCalibrationStep.getId());
		Assert.assertNotNull(dbCalibrationStep.getHoleSize());
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
