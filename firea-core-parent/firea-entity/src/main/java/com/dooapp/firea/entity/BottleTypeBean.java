...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for bottleconfiguration unsetter
	 * End of user code -->
	 */
	...
	public Element toXML(){
		Element e = new Element("BottleType");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		if (getName() != null)
			e.setAttribute(new Attribute("name", getName()));
		e.setAttribute(new Attribute("weight", String.valueOf(getWeight())));
		e.setAttribute(new Attribute("volume", String.valueOf(getVolume())));
		...
		if (getBottleconfiguration() != null)
			e.setAttribute("bottleconfiguration", String.valueOf(getBottleconfiguration().getId()));
