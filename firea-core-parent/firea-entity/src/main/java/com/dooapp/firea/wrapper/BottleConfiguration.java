...
// End of user code
{
	...
	public StringProperty unitProperty(){
		if (this.unitProperty == null) {
			this.unitProperty = new SimpleStringProperty(bottleConfiguration.getUnit());
			this.unitProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					bottleConfiguration.setUnit((String) arg2);
				}
			});
	...
	public String toXML(){
		...
		return getBottleConfigurationBean() != null ? serializer.outputString(getBottleConfigurationBean().toXML()) : "";
