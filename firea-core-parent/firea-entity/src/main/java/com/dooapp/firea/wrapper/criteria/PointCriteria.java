 ...
 * @generated
 */
//@BeanClass(PointCriteriaBean.class)
...
// End of user code
{
	...
	public DoubleProperty pressureGoalMaxProperty(){
		if (this.pressureGoalMaxProperty == null) {
			this.pressureGoalMaxProperty = createPressureGoalMaxProperty();
			getBean().setPressureGoalMax(getBean().getPressureGoalMax());
			this.pressureGoalMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setPressureGoalMax((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createPressureGoalMaxProperty(){
		return new SimpleDoubleProperty(getBean().getPressureGoalMax());
	}
	 ...
	 * @generated
	 */
	public void updatePressureGoalMaxAndWait(final Double myPressureGoalMax) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setPressureGoalMax(myPressureGoalMax);
		} else {
			final Object mutex = new Object();
	...
	public DoubleProperty pressureGoalMinProperty(){
		if (this.pressureGoalMinProperty == null) {
			this.pressureGoalMinProperty = createPressureGoalMinProperty();
			getBean().setPressureGoalMin(getBean().getPressureGoalMin());
			this.pressureGoalMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setPressureGoalMin((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createPressureGoalMinProperty(){
		return new SimpleDoubleProperty(getBean().getPressureGoalMin());
	}
	 ...
	 * @generated
	 */
	public void updatePressureGoalMinAndWait(final Double myPressureGoalMin) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setPressureGoalMin(myPressureGoalMin);
		} else {
			final Object mutex = new Object();
