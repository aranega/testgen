...
// End of user code
{
	...
	private void handleDefaultBottletype(BottleConfiguration result) {
		...
		result.setBottletype(bottleTypeBuilder.bottleconfiguration(result).build());
		// End of user code
	}
	...
	private void handleDefaultGazconfiguration(BottleConfiguration result) {
		...
		result.setGazconfiguration(gazConfigurationBuilder.bottleconfigurations(result).build());
		// End of user code
	}
