...
// End of user code
{
	...
	public Element toDomXML(){
		Element xmlElement = new Element("Risque");
		...
		if (getKey() != null)
			xmlElement.setAttribute(new Attribute("key", getKey()));
	...
	public void accept(FireaVisitor visitor) {
		visitor.visitBeforeRisque(this);
		
		this.visitInternal(visitor);
		
		visitor.visitAfterRisque(this);
	}
