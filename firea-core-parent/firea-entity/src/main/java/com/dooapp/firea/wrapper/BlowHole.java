...
// End of user code
{
	...
	public StringProperty dischargeProperty(){
		if (this.dischargeProperty == null) {
			this.dischargeProperty = new SimpleStringProperty(blowHole.getDischarge());
			this.dischargeProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					blowHole.setDischarge((String) arg2);
				}
			});
	...
	public String toXML(){
		...
		return getBlowHoleBean() != null ? serializer.outputString(getBlowHoleBean().toXML()) : "";
