...
//End of user code
{
	...
	public Element toXML(){
		...
		if (getCity() != null)
			e.setAttribute(new Attribute("city", getCity()));
		if (getPhone() != null)
			e.setAttribute(new Attribute("phone", getPhone()));
		if (getAdress1() != null)
			e.setAttribute(new Attribute("adress1", getAdress1()));
		if (getZipCode() != null)
			e.setAttribute(new Attribute("zipCode", getZipCode()));
		if (getSiret() != null)
			e.setAttribute(new Attribute("siret", getSiret()));
		if (getEmail() != null)
			e.setAttribute(new Attribute("email", getEmail()));
		if (getKind() != null)
			e.setAttribute(new Attribute("kind", getKind()));
		if (getName() != null)
			e.setAttribute(new Attribute("name", getName()));
		if (getAddress2() != null)
			e.setAttribute(new Attribute("address2", getAddress2()));
		if (getPerson() != null)
			e.setAttribute(new Attribute("person", getPerson()));
