...
//End of user code
{
	...
	@javax.persistence.OneToOne(optional = false, cascade = javax.persistence.CascadeType.ALL, mappedBy = "blowholes")
	...
	public Element toXML(){
		Element e = new Element("BlowHole");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		e.setAttribute(new Attribute("surface", String.valueOf(getSurface())));
		if (getDischarge() != null)
			e.setAttribute(new Attribute("Discharge", getDischarge()));
		e.setAttribute(new Attribute("quantity", String.valueOf(getQuantity())));
		...
		if (getTestedroom() != null)
			e.setAttribute("testedroom", String.valueOf(getTestedroom().getId()));
