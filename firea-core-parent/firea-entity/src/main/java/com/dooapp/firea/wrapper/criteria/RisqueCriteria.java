 ...
 * @generated
 */
//@BeanClass(RisqueCriteriaBean.class)
...
// End of user code
{
	...
	public StringProperty keyProperty(){
		if (this.keyProperty == null) {
			this.keyProperty = createKeyProperty();
			getBean().setKey(getBean().getKey());
			this.keyProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					getBean().setKey((String) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected StringProperty createKeyProperty(){
		return new SimpleStringProperty(getBean().getKey());
	}
	 ...
	 * @generated
	 */
	public void updateKeyAndWait(final String myKey) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setKey(myKey);
		} else {
			final Object mutex = new Object();
