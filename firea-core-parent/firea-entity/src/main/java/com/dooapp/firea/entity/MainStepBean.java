...
//End of user code
{
	...
	public Element toXML(){
		Element e = new Element("MainStep");
		if (uuid != null)
		...
		e.setAttribute(new Attribute("correlation", String.valueOf(getCorrelation())));
		e.setAttribute(new Attribute("cl", String.valueOf(getCl())));
		e.setAttribute(new Attribute("n", String.valueOf(getN())));
		e.setAttribute(new Attribute("calculatedELA", String.valueOf(getCalculatedELA())));
