...
public class PersistentImageBean
...
//End of user code
{
	...
	public Element toXML(){
		Element e = new Element("PersistentImage");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		if (getDataId() != null)
			e.setAttribute(new Attribute("dataId", getDataId()));
		if (getPreview() != null)
			e.setAttribute(new Attribute("preview", getPreview()));
		if (getSourceFile() != null)
			e.setAttribute(new Attribute("sourceFile", getSourceFile()));
		if (getTitle() != null)
			e.setAttribute(new Attribute("title", getTitle()));
		e.setAttribute(new Attribute("error", String.valueOf(isError())));
		...
		if (getContact() != null)
			e.setAttribute("contact", String.valueOf(getContact().getId()));
