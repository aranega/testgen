...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for Risque wrapper getter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	@Override
	...
	/*
	 * <!-- Start of user code comment for Risque wrapper setter
	 * End of user code -->
	 */
	@javax.persistence.Transient
	...
	public Element toXML(){
		Element e = new Element("Risque");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		if (getKey() != null)
			e.setAttribute(new Attribute("key", getKey()));
		e.setAttribute(new Attribute("tab", String.valueOf(getTab())));
