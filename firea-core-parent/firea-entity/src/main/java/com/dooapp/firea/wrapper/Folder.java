...
// End of user code
{
	...
	public IntegerProperty displayOrderProperty(){
		if (this.displayOrderProperty == null) {
			this.displayOrderProperty = createDisplayOrderProperty();
			getBean().setDisplayOrder(getBean().getDisplayOrder());
			this.displayOrderProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setDisplayOrder((Integer) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected IntegerProperty createDisplayOrderProperty(){
		return new SimpleIntegerProperty(getBean().getDisplayOrder());
	}
	 ...
	 * @generated
	 */
	public void updateDisplayOrder(final Integer myDisplayOrder) {
		if (javafx.application.Platform.isFxApplicationThread()) {
	 ...
	 * @generated
	 */
	public void updateDisplayOrderAndWait(final Integer myDisplayOrder) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setDisplayOrder(myDisplayOrder);
		} else {
			final Object mutex = new Object();
	...
	public void accept(FireaVisitor visitor) {
		visitor.visitBeforeFolder(this);
		
		this.visitInternal(visitor);
		
		visitor.visitAfterFolder(this);
	}
