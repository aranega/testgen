...
import com.dooapp.firea.entity.criteria.ReportTemplateCriteriaInstance;
 ...
 * @generated
 */
public class ReportTemplateCriteria 
...
// End of user code
{
	 ...
	 * @generated
 	 */
	private ReportTemplateCriteriaInstance reportTemplateCriteria;
	...
	public ReportTemplateCriteria(){
		this(new ReportTemplateCriteriaInstance());
	}
	 ...
	 * @generated
	 */
	public ReportTemplateCriteria(ReportTemplateCriteriaInstance entity) {
		...
		this.reportTemplateCriteria = entity;
	}
	 ...
	 * @generated
	 */
	public ReportTemplateCriteriaInstance getReportTemplateCriteriaInstance(){
		return this.reportTemplateCriteria;
	}
	 ...
	 * @generated
	 */
	public ReportTemplateCriteriaInstance getBean() {
		return  this.reportTemplateCriteria;
	}
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			creationDateMaxProperty = new SimpleObjectProperty<java.util.Date>(reportTemplateCriteria.getCreationDateMax());
			creationDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplateCriteria.setCreationDateMax(arg2);
				}
			});
		}
	...
	public void setCreationDateMax(java.util.Date myCreationDateMax){
		if (creationDateMaxProperty == null) {
				reportTemplateCriteria.setCreationDateMax(myCreationDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			creationDateMinProperty = new SimpleObjectProperty<java.util.Date>(reportTemplateCriteria.getCreationDateMin());
			creationDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplateCriteria.setCreationDateMin(arg2);
				}
			});
		}
	...
	public void setCreationDateMin(java.util.Date myCreationDateMin){
		if (creationDateMinProperty == null) {
				reportTemplateCriteria.setCreationDateMin(myCreationDateMin);
			} else {
	...
	public StringProperty descriptionProperty(){
		if (this.descriptionProperty == null) {
			this.descriptionProperty = new SimpleStringProperty(reportTemplateCriteria.getDescription());
			this.descriptionProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplateCriteria.setDescription((String) arg2);
				}
			});
		}
	...
	public StringProperty fileProperty(){
		if (this.fileProperty == null) {
			this.fileProperty = new SimpleStringProperty(reportTemplateCriteria.getFile());
			this.fileProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplateCriteria.setFile((String) arg2);
				}
			});
		}
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			this.idMaxProperty = new SimpleLongProperty(reportTemplateCriteria.getIdMax());
			this.idMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					reportTemplateCriteria.setIdMax((Long) arg2);
				}
			});
		}
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			this.idMinProperty = new SimpleLongProperty(reportTemplateCriteria.getIdMin());
			this.idMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					reportTemplateCriteria.setIdMin((Long) arg2);
				}
			});
		}
	...
	public ObjectProperty<ProjectKind> kindProperty() {
		if (kindProperty == null) {
			kindProperty = new SimpleObjectProperty<ProjectKind>(reportTemplateCriteria.getKind());
			kindProperty.addListener(new ChangeListener<ProjectKind>() {
				...
				public void changed(ObservableValue<? extends ProjectKind> arg0, ProjectKind arg1, ProjectKind arg2) {
					reportTemplateCriteria.setKind(arg2);
				}
			});
		}
		return kindProperty;
	...
	public void setKind(ProjectKind myKind){
		if (kindProperty == null) {
				reportTemplateCriteria.setKind(myKind);
			} else {
	...
	public StringProperty nameProperty(){
		if (this.nameProperty == null) {
			this.nameProperty = new SimpleStringProperty(reportTemplateCriteria.getName());
			this.nameProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplateCriteria.setName((String) arg2);
				}
			});
		}
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			updateDateMaxProperty = new SimpleObjectProperty<java.util.Date>(reportTemplateCriteria.getUpdateDateMax());
			updateDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplateCriteria.setUpdateDateMax(arg2);
				}
			});
		}
	...
	public void setUpdateDateMax(java.util.Date myUpdateDateMax){
		if (updateDateMaxProperty == null) {
				reportTemplateCriteria.setUpdateDateMax(myUpdateDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			updateDateMinProperty = new SimpleObjectProperty<java.util.Date>(reportTemplateCriteria.getUpdateDateMin());
			updateDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplateCriteria.setUpdateDateMin(arg2);
				}
			});
		}
	...
	public void setUpdateDateMin(java.util.Date myUpdateDateMin){
		if (updateDateMinProperty == null) {
				reportTemplateCriteria.setUpdateDateMin(myUpdateDateMin);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(reportTemplateCriteria.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					reportTemplateCriteria.setVersion((Integer) arg2);
				}
			});
		}
