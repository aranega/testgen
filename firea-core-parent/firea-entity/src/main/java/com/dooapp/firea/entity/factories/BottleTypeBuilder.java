...
// End of user code
{
	...
	public BottleType build() throws NullPointerException {
		...
		if (bottleconfiguration == null) {
			throw new NullPointerException("BottleType must be linked to a BottleConfiguration which has not been set.");
		} else { 
			result.setBottleconfiguration(bottleconfiguration);
		}
	...
	public BUILDER bottleconfiguration(BottleConfiguration myBottleconfiguration) {
		this.bottleconfiguration = myBottleconfiguration;
		return (BUILDER) this;
	}
