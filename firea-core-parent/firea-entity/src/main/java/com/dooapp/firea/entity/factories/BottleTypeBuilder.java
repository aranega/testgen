...
// End of user code
{
	...
	protected BottleType createValue() {
		return new BottleType(new BottleTypeBean());
	}
	...
	public BottleType build() throws NullPointerException {
		...
		if (bottleconfiguration == null) {
			...
			for (BottleConfiguration tmp : bottleconfiguration)
				tmp.setBottletype(result);
			result.getBottleconfiguration().addAll(bottleconfiguration);
		}
	 ...
	 * @generated
	 */
	protected void handleDefaultBottleconfiguration(BottleType result) throws NullPointerException {
		// do nothing
	}
	 ...
	 * @generated
	 */
	protected void handleDefaultCreationDate(BottleType result) {
		try {
	 ...
	 * @generated
	 */
	protected void handleDefaultId(BottleType result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultName(BottleType result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultUpdateDate(BottleType result) {
		try {
	 ...
	 * @generated
	 */
	protected void handleDefaultVersion(BottleType result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultVolume(BottleType result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultWeight(BottleType result) {
