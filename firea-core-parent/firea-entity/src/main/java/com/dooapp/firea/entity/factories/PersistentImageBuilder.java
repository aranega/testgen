...
// End of user code
{
	 ...
	 */
	/*
	 * <!-- Start of user code comment for contact default method
	 * End of user code -->
	 */
	private void handleDefaultContact(PersistentImage result) {
		// Start of user code default feature for handleDefaultContact
		result.setContact(contactBuilder.image(result).build());
		// End of user code
	}
	...
	/*
	 * <!-- Start of user code comment for preview default method
	 * End of user code -->
	 */
	...
	/*
	 * <!-- Start of user code comment for contact
	 * End of user code -->
	 */
	public BUILDER contact(Contact myContact) {
	...
	/*
	 * <!-- Start of user code comment for preview
	 * End of user code -->
	 */
