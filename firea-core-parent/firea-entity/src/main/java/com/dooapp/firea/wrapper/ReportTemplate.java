...
import com.dooapp.firea.entity.ReportTemplateBean;
...
// End of user code
{
	 ...
	 * @generated
 	 */
	private final ReportTemplateBean reportTemplate;
	 ...
	 * @generated
	 */
	public ReportTemplate(ReportTemplateBean entity) {
		if (entity == null) {
	 ...
	 * @generated
	 */
	public ReportTemplateBean getReportTemplateBean(){
	 ...
	 * @generated
	 */
	public ReportTemplateBean getBean() {
		return  this.reportTemplate;
	}
	...
	public ObjectProperty<java.util.Date> creationDateProperty() {
		if (creationDateProperty == null) {
			creationDateProperty = new SimpleObjectProperty<java.util.Date>(reportTemplate.getCreationDate());
			creationDateProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplate.setCreationDate(arg2);
				}
			});
		}
	...
	public void setCreationDate(java.util.Date myCreationDate){
		if (creationDateProperty == null) {
				reportTemplate.setCreationDate(myCreationDate);
			} else {
	...
	public StringProperty descriptionProperty(){
		if (this.descriptionProperty == null) {
			this.descriptionProperty = new SimpleStringProperty(reportTemplate.getDescription());
			this.descriptionProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplate.setDescription((String) arg2);
				}
			});
		}
	...
	public StringProperty fileProperty(){
		if (this.fileProperty == null) {
			this.fileProperty = new SimpleStringProperty(reportTemplate.getFile());
			this.fileProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplate.setFile((String) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	public void updateFile(final String myFile, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setFile(myFile);
			if (mutex != null) {
				mutex.notify();
	 ...
	 * @generated
	 */
	public void updateFile(final String myFile) {
		updateFile(myFile, null);
	}
	...
	public LongProperty idProperty(){
		if (this.idProperty == null) {
			this.idProperty = new SimpleLongProperty(reportTemplate.getId());
			this.idProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					reportTemplate.setId((Long) arg2);
				}
			});
		}
	...
	public ObjectProperty<PersistentImage> imageProperty() {
		if (imageProperty == null) {
			imageProperty = new SimpleObjectProperty<PersistentImage>(reportTemplate.getImage() == null ? null : reportTemplate
					.getImage().getWrapper());
			imageProperty.addListener(new ChangeListener<PersistentImage>() {
				...
				public void changed(ObservableValue<? extends PersistentImage> obj, PersistentImage oldValue, PersistentImage newValue) {
					reportTemplate.setImage(newValue == null ? null : newValue.getBean());
				}
			});
		}
	...
	public void setImage(PersistentImage myImage){
		if (imageProperty == null) {
				reportTemplate.setImage(myImage == null ? null : myImage.getBean());
			} else {
	...
	public ObjectProperty<ProjectKind> kindProperty() {
		if (kindProperty == null) {
			kindProperty = new SimpleObjectProperty<ProjectKind>(reportTemplate.getKind());
	...
	public StringProperty nameProperty(){
		if (this.nameProperty == null) {
			this.nameProperty = new SimpleStringProperty(reportTemplate.getName());
			this.nameProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					reportTemplate.setName((String) arg2);
				}
			});
		}
	...
	public ObjectProperty<java.util.Date> updateDateProperty() {
		if (updateDateProperty == null) {
			updateDateProperty = new SimpleObjectProperty<java.util.Date>(reportTemplate.getUpdateDate());
			updateDateProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					reportTemplate.setUpdateDate(arg2);
				}
			});
		}
	...
	public void setUpdateDate(java.util.Date myUpdateDate){
		if (updateDateProperty == null) {
				reportTemplate.setUpdateDate(myUpdateDate);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(reportTemplate.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					reportTemplate.setVersion((Integer) arg2);
				}
			});
		}
	...
	public String toXML(){
		...
		return getReportTemplateBean() != null ? serializer.outputString(this.toDomXML()) : "";
	...
	private Element toDomXML(){
		Element xmlElement = new Element("ReportTemplate");
		...
		if (getFile() != null)
			xmlElement.setAttribute(new Attribute("file", getFile()));
		if (getName() != null)
