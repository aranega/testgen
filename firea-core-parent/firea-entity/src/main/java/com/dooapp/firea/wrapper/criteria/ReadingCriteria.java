 ...
 * @generated
 */
//@BeanClass(ReadingCriteriaBean.class)
...
// End of user code
{
	...
	public DoubleProperty buildingPressureMaxProperty(){
		if (this.buildingPressureMaxProperty == null) {
			this.buildingPressureMaxProperty = createBuildingPressureMaxProperty();
			getBean().setBuildingPressureMax(getBean().getBuildingPressureMax());
			this.buildingPressureMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setBuildingPressureMax((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createBuildingPressureMaxProperty(){
		return new SimpleDoubleProperty(getBean().getBuildingPressureMax());
	}
	 ...
	 * @generated
	 */
	public void updateBuildingPressureMaxAndWait(final Double myBuildingPressureMax) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setBuildingPressureMax(myBuildingPressureMax);
		} else {
	...
	public DoubleProperty buildingPressureMinProperty(){
		if (this.buildingPressureMinProperty == null) {
			this.buildingPressureMinProperty = createBuildingPressureMinProperty();
			getBean().setBuildingPressureMin(getBean().getBuildingPressureMin());
			this.buildingPressureMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setBuildingPressureMin((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createBuildingPressureMinProperty(){
		return new SimpleDoubleProperty(getBean().getBuildingPressureMin());
	}
	 ...
	 * @generated
	 */
	public void updateBuildingPressureMinAndWait(final Double myBuildingPressureMin) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setBuildingPressureMin(myBuildingPressureMin);
		} else {
			final Object mutex = new Object();
	...
	public DoubleProperty fanPressureMaxProperty(){
		if (this.fanPressureMaxProperty == null) {
			this.fanPressureMaxProperty = createFanPressureMaxProperty();
			getBean().setFanPressureMax(getBean().getFanPressureMax());
			this.fanPressureMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setFanPressureMax((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createFanPressureMaxProperty(){
		return new SimpleDoubleProperty(getBean().getFanPressureMax());
	}
	 ...
	 * @generated
	 */
	public void updateFanPressureMaxAndWait(final Double myFanPressureMax) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setFanPressureMax(myFanPressureMax);
		} else {
			final Object mutex = new Object();
	...
	public DoubleProperty fanPressureMinProperty(){
		if (this.fanPressureMinProperty == null) {
			this.fanPressureMinProperty = createFanPressureMinProperty();
			getBean().setFanPressureMin(getBean().getFanPressureMin());
			this.fanPressureMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setFanPressureMin((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createFanPressureMinProperty(){
		return new SimpleDoubleProperty(getBean().getFanPressureMin());
	}
	 ...
	 * @generated
	 */
	public void updateFanPressureMinAndWait(final Double myFanPressureMin) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setFanPressureMin(myFanPressureMin);
		} else {
			final Object mutex = new Object();
