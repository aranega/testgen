...
// End of user code
{
	...
	public String toXML(){
		...
		return getBottleTypeBean() != null ? serializer.outputString(this.toDomXML()) : "";
	...
	private Element toDomXML(){
		...
		if (getBottleconfiguration() != null)
			xmlElement.setAttribute("bottleconfiguration", String.valueOf(getBottleconfiguration().getId()));
