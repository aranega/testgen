...
// Start of user code comment for PersistentImageData Class
...
// End of user code
{
	...
	/*
	 * Constructors
	 * <!-- Start of user code comment for PersistentImageData constructor
	 * End of user code -->
	 */
	...
	public String toXML(){
		...
		return getPersistentImageDataBean() != null ? serializer.outputString(getPersistentImageDataBean().toXML()) : "";
