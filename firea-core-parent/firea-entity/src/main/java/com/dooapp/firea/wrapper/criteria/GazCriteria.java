 ...
 * @generated
 */
//@BeanClass(GazCriteriaBean.class)
...
// End of user code
{
	...
	public DoubleProperty densityMaxProperty(){
		if (this.densityMaxProperty == null) {
			this.densityMaxProperty = createDensityMaxProperty();
			getBean().setDensityMax(getBean().getDensityMax());
			this.densityMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setDensityMax((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createDensityMaxProperty(){
		return new SimpleDoubleProperty(getBean().getDensityMax());
	}
	 ...
	 * @generated
	 */
	public void updateDensityMaxAndWait(final Double myDensityMax) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setDensityMax(myDensityMax);
		} else {
			final Object mutex = new Object();
	...
	public DoubleProperty densityMinProperty(){
		if (this.densityMinProperty == null) {
			this.densityMinProperty = createDensityMinProperty();
			getBean().setDensityMin(getBean().getDensityMin());
			this.densityMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					getBean().setDensityMin((Double) arg2);
				}
			});
		}
	 ...
	 * @generated
	 */
	protected DoubleProperty createDensityMinProperty(){
		return new SimpleDoubleProperty(getBean().getDensityMin());
	}
	 ...
	 * @generated
	 */
	public void updateDensityMinAndWait(final Double myDensityMin) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setDensityMin(myDensityMin);
		} else {
			final Object mutex = new Object();
