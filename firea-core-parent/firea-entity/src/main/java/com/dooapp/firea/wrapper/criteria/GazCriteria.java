...
// End of user code
{
	...
	public IntegerProperty typeProperty(){
		if (this.typeProperty == null) {
			this.typeProperty = new SimpleIntegerProperty(gazCriteria.getType());
			this.typeProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					gazCriteria.setType((Integer) arg2);
				}
			});
	...
	public StringProperty weightProperty(){
		if (this.weightProperty == null) {
			this.weightProperty = new SimpleStringProperty(gazCriteria.getWeight());
			this.weightProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					gazCriteria.setWeight((String) arg2);
				}
			});
