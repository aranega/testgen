...
// End of user code
{
	 ...
	 * @generated
	 */
	private void handleDefaultBlowhole(BlowHoleConfiguration result) {
		// result.setBlowhole(null);
	}
	 ...
	 * @generated
	 */
	private void handleDefaultTestedroom(BlowHoleConfiguration result) throws NullPointerException {
		// result.setTestedroom(null);
	}
