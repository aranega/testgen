...
// End of user code
{
	...
	/*
	 * Constructors
	 * <!-- Start of user code comment for Device constructor
	 * End of user code -->
	 */
	public Device(){
		this(new DeviceBean());	
	...
	/*
	 * <!-- Start of user code comment for lastCalibrationDate property method 
		-->
	 * <!-- End of user code -->
	 */
	...
	public String toXML(){
		...
		return getDeviceBean() != null ? serializer.outputString(getDeviceBean().toXML()) : "";
