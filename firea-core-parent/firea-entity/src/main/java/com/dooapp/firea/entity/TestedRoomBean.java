...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for blowholes unsetter
	 * End of user code -->
	 */
	...
	public Element toXML(){
		Element e = new Element("TestedRoom");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		e.setAttribute(new Attribute("clapetsCF", String.valueOf(isClapetsCF())));
		e.setAttribute(new Attribute("climWithNewAirAuto", String.valueOf(isClimWithNewAirAuto())));
		if (getCommissioningDate() != null)
			e.setAttribute(new Attribute("CommissioningDate", getCommissioningDate().toString()));
		e.setAttribute(new Attribute("climReclycle", String.valueOf(isClimReclycle())));
		e.setAttribute(new Attribute("climVMC", String.valueOf(isClimVMC())));
		e.setAttribute(new Attribute("risqueHeightPercent", String.valueOf(getRisqueHeightPercent())));
		e.setAttribute(new Attribute("altitude", String.valueOf(getAltitude())));
		e.setAttribute(new Attribute("netVolume", String.valueOf(getNetVolume())));
		e.setAttribute(new Attribute("unloadTime", String.valueOf(getUnloadTime())));
		e.setAttribute(new Attribute("climReclycleAuto", String.valueOf(isClimReclycleAuto())));
		e.setAttribute(new Attribute("totalHeight", String.valueOf(getTotalHeight())));
		e.setAttribute(new Attribute("indicatedVolume", String.valueOf(getIndicatedVolume())));
		e.setAttribute(new Attribute("minimalProtectedHeight", String.valueOf(getMinimalProtectedHeight())));
		if (getClimVMCAuto() != null)
			e.setAttribute(new Attribute("climVMCAuto", getClimVMCAuto()));
		if (getName() != null)
			e.setAttribute(new Attribute("name", getName()));
		e.setAttribute(new Attribute("choosenProtectedHeight", String.valueOf(getChoosenProtectedHeight())));
		e.setAttribute(new Attribute("measuredVolume", String.valueOf(getMeasuredVolume())));
		e.setAttribute(new Attribute("droppedFloor", String.valueOf(getDroppedFloor())));
		e.setAttribute(new Attribute("droppedCeiling", String.valueOf(getDroppedCeiling())));
		e.setAttribute(new Attribute("climWithNewAir", String.valueOf(isClimWithNewAir())));
		e.setAttribute(new Attribute("mecanicalStrength", String.valueOf(getMecanicalStrength())));
		e.setAttribute(new Attribute("risqueHeight", String.valueOf(getRisqueHeight())));
		e.setAttribute(new Attribute("mainHeight", String.valueOf(getMainHeight())));
		e.setAttribute(new Attribute("uniformHorizontality", String.valueOf(isUniformHorizontality())));
		e.setAttribute(new Attribute("volumeCorrection", String.valueOf(getVolumeCorrection())));
		e.setAttribute(new Attribute("climDuct", String.valueOf(isClimDuct())));
		...
		if (getBlowholes() != null)
			e.setAttribute("blowholes", String.valueOf(getBlowholes().getId()));
