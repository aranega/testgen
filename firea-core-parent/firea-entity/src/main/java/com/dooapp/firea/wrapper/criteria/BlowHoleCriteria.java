...
// End of user code
{
	 ...
	 * @generated
	 */
	private DoubleProperty openingPressureMaxProperty;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
	 */
	private DoubleProperty openingPressureMinProperty;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
	...
	public ObjectProperty<Discharge> dischargeProperty() {
		if (dischargeProperty == null) {
			dischargeProperty = new SimpleObjectProperty<Discharge>(blowHoleCriteria.getDischarge());
	 ...
	 * @generated
	 */
	public DoubleProperty openingPressureMaxProperty(){
		if (this.openingPressureMaxProperty == null) {
			this.openingPressureMaxProperty = new SimpleDoubleProperty(blowHoleCriteria.getOpeningPressureMax());
			this.openingPressureMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					blowHoleCriteria.setOpeningPressureMax((Double) arg2);
				}
			});
		}
		return this.openingPressureMaxProperty;
	}
	 ...
	 * @generated
	 */
	public double getOpeningPressureMax(){
		return openingPressureMaxProperty().get();
	} 
	 ...
	 * @generated
	 */
	public void setOpeningPressureMax(double myOpeningPressureMax){
		this.openingPressureMaxProperty().set(myOpeningPressureMax);
	}
	 ...
	 * @generated
	 */
	public void updateOpeningPressureMax(final double myOpeningPressureMax, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setOpeningPressureMax(myOpeningPressureMax);
			if (mutex != null) {
				mutex.notify();
			}
		} else {
	 ...
	 * @generated
	 */
	public void updateOpeningPressureMax(final double myOpeningPressureMax) {
		updateOpeningPressureMax(myOpeningPressureMax, null);
	}
	 ...
	 * @generated
	 */
	public DoubleProperty openingPressureMinProperty(){
		if (this.openingPressureMinProperty == null) {
			this.openingPressureMinProperty = new SimpleDoubleProperty(blowHoleCriteria.getOpeningPressureMin());
			this.openingPressureMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					blowHoleCriteria.setOpeningPressureMin((Double) arg2);
				}
			});
		}
		return this.openingPressureMinProperty;
	}
	 ...
	 * @generated
	 */
	public double getOpeningPressureMin(){
		return openingPressureMinProperty().get();
	} 
	 ...
	 * @generated
	 */
	public void setOpeningPressureMin(double myOpeningPressureMin){
		this.openingPressureMinProperty().set(myOpeningPressureMin);
	}
	 ...
	 * @generated
	 */
	public void updateOpeningPressureMin(final double myOpeningPressureMin, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setOpeningPressureMin(myOpeningPressureMin);
			if (mutex != null) {
				mutex.notify();
			}
		} else {
	 ...
	 * @generated
	 */
	public void updateOpeningPressureMin(final double myOpeningPressureMin) {
		updateOpeningPressureMin(myOpeningPressureMin, null);
	}
