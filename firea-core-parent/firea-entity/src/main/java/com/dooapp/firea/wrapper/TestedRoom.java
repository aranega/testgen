...
// End of user code
{
	...
	public ReadOnlyObjectProperty<ObservableList<BlowHole>> blowholesProperty() {
		if (blowholesProperty == null) {
			...
			for (BlowHoleBean tmp : this.testedRoom.getBlowholes()) {
				blowholesProperty.get().add(tmp.getWrapper());
			}
	...
	public String toXML(){
		...
		return getTestedRoomBean() != null ? serializer.outputString(getTestedRoomBean().toXML()) : "";
