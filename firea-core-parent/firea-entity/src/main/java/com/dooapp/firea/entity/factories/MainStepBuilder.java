...
// End of user code
{
	...
	protected MainStep createValue() {
		return new MainStep(new MainStepBean());
	}
	 ...
	 * @generated
	 */
	protected void handleDefaultCalculatedELA(MainStep result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultCl(MainStep result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultCorrelation(MainStep result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultDirection(MainStep result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultN(MainStep result) {
