...
// End of user code
{
	...
	private ObjectProperty<BottleType> bottletypesProperty;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<BottleType> bottletypesProperty() {
		if (bottletypesProperty == null) {
			bottletypesProperty = new SimpleObjectProperty<BottleType>(gaz.getBottletypes() == null ? null : gaz
					.getBottletypes().getWrapper());
			bottletypesProperty.addListener(new ChangeListener<BottleType>() {
				@Override
				public void changed(ObservableValue<? extends BottleType> obj, BottleType oldValue, BottleType newValue) {
					gaz.setBottletypes(newValue == null ? null : newValue.getBean());
				}
			});
		}
	 ...
	 * @generated
	 */
	public BottleType getBottletypes(){
	 ...
	 * @generated
	 */
	public void setBottletypes(BottleType myBottletypes){
		if (bottletypesProperty == null) {
				gaz.setBottletypes(myBottletypes == null ? null : myBottletypes.getBean());
			} else {
				this.bottletypesProperty().set(myBottletypes);
			}
	}
	 ...
	 * @generated
	 */
	public void updateBottletypes(final BottleType myBottletypes, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setBottletypes(myBottletypes);
			if (mutex != null) {
				mutex.notify();
			}
		} else {
	 ...
	 * @generated
	 */
	public void updateBottletypes(final BottleType myBottletypes) {
		updateBottletypes(myBottletypes, null);
	}
	...
	public ObjectProperty<GazConfiguration> gazconfigurationProperty() {
		if (gazconfigurationProperty == null) {
			gazconfigurationProperty = new SimpleObjectProperty<GazConfiguration>(gaz.getGazconfiguration() == null ? null : gaz
			...
			gazconfigurationProperty.addListener(new ChangeListener<GazConfiguration>() {
				...
				public void changed(ObservableValue<? extends GazConfiguration> obj, GazConfiguration oldValue, GazConfiguration newValue) {
					gaz.setGazconfiguration(newValue == null ? null : newValue.getBean());
				}
			});
		}
	...
	public void setGazconfiguration(GazConfiguration myGazconfiguration){
		if (gazconfigurationProperty == null) {
				gaz.setGazconfiguration(myGazconfiguration == null ? null : myGazconfiguration.getBean());
			} else {
	...
	public ObjectProperty<GazWeight> weightProperty() {
		if (weightProperty == null) {
			weightProperty = new SimpleObjectProperty<GazWeight>(gaz.getWeight());
	...
	public String toXML(){
		...
		return getGazBean() != null ? serializer.outputString(this.toDomXML()) : "";
	...
	private Element toDomXML(){
		...
		if (getBottletypes() != null)
			xmlElement.setAttribute("bottletypes", String.valueOf(getBottletypes().getId()));
