...
//End of user code
{
	...
	/*
	 * <!-- Start of user code comment for bottleconfigurations unsetter
	 * End of user code -->
	 */
	...
	public Element toXML(){
		Element e = new Element("GazConfiguration");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		e.setAttribute(new Attribute("droppedCeilFull", String.valueOf(isDroppedCeilFull())));
		e.setAttribute(new Attribute("slowUnloadingValue", String.valueOf(getSlowUnloadingValue())));
		e.setAttribute(new Attribute("slowUnloading", String.valueOf(isSlowUnloading())));
		e.setAttribute(new Attribute("leekRepartitionPercent", String.valueOf(getLeekRepartitionPercent())));
		e.setAttribute(new Attribute("retentionInterface", String.valueOf(isRetentionInterface())));
		e.setAttribute(new Attribute("retentionGoal", String.valueOf(getRetentionGoal())));
		e.setAttribute(new Attribute("droppedFloorFull", String.valueOf(isDroppedFloorFull())));
		...
		if (getGaz() != null)
			e.setAttribute("gaz", String.valueOf(getGaz().getId()));
		if (getProject() != null)
			e.setAttribute("project", String.valueOf(getProject().getId()));
		if (getBottleconfigurations() != null)
			e.setAttribute("bottleconfigurations", String.valueOf(getBottleconfigurations().getId()));
