...
// End of user code
{
	...
	/*
	 * <!-- Start of user code comment for highUp property method 
		-->
	 * <!-- End of user code -->
	 */
	...
	public ReadOnlyObjectProperty<ObservableList<Step>> stepProperty() {
		if (stepProperty == null) {
			...
			for (StepBean tmp : this.sample.getStep()) {
				stepProperty.get().add(tmp.getWrapper());
			}
	...
	public String toXML(){
		...
		return getSampleBean() != null ? serializer.outputString(getSampleBean().toXML()) : "";
