...
// End of user code
{
	...
	private void handleDefaultGazconfiguration(Gaz result) {
		...
		result.setGazconfiguration(gazConfigurationBuilder.gaz(result).build());
		// End of user code
	}
	...
	private void handleDefaultWeight(Gaz result) {
		...
		result.setWeight(cfg.getProperty("defaultValue.Gaz.weight"));
		// End of user code
	}
	 ...
	 * End of user code -->
	 */
	public BUILDER weight(String myWeight) {
