...
//End of user code
{
	...
	public Element toXML(){
		...
		e.setAttribute(new Attribute("roE", String.valueOf(getRoE())));
		e.setAttribute(new Attribute("roI", String.valueOf(getRoI())));
		if (getName() != null)
			e.setAttribute(new Attribute("name", getName()));
		e.setAttribute(new Attribute("windMeasure", String.valueOf(getWindMeasure())));
		e.setAttribute(new Attribute("tetaE", String.valueOf(getTetaE())));
		e.setAttribute(new Attribute("phiEPercent", String.valueOf(getPhiEPercent())));
		if (getAirPressureCalculationMethod() != null)
			e.setAttribute(new Attribute("airPressureCalculationMethod", getAirPressureCalculationMethod()));
		if (getBeaufortScale() != null)
			e.setAttribute(new Attribute("beaufortScale", getBeaufortScale()));
		e.setAttribute(new Attribute("tetaI", String.valueOf(getTetaI())));
		if (getStatus() != null)
			e.setAttribute(new Attribute("status", getStatus()));
		e.setAttribute(new Attribute("airPressure", String.valueOf(getAirPressure())));
		e.setAttribute(new Attribute("phiIPercent", String.valueOf(getPhiIPercent())));
