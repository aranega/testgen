...
//End of user code
{
	...
	@javax.persistence.OneToOne(optional = false, cascade = javax.persistence.CascadeType.ALL, mappedBy = "bottleconfiguration")
	private BottleTypeBean bottletype;
	@javax.persistence.Column(name = "CREATION_DATE")
	@javax.persistence.Temporal(javax.persistence.TemporalType.TIMESTAMP)
	private java.util.Date creationDate;
	
	@javax.persistence.OneToOne(optional = false, cascade = javax.persistence.CascadeType.ALL, mappedBy = "bottleconfigurations")
	...
	public void unsetBottletype(){
			...
			BottleTypeBean oldbottletype = this.bottletype;
			this.bottletype = null;
			oldbottletype.unsetBottleconfiguration();
	} 
	/*
	...
	public void unsetGazconfiguration(){
			...
			oldgazconfiguration.unsetBottleconfigurations();
	} 
	/*
	...
	public Element toXML(){
		Element e = new Element("BottleConfiguration");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		e.setAttribute(new Attribute("load", String.valueOf(getLoad())));
		if (getUnit() != null)
			e.setAttribute(new Attribute("unit", getUnit()));
		...
		if (getBottletype() != null)
			e.setAttribute("bottletype", String.valueOf(getBottletype().getId()));
