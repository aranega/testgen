...
// End of user code
{
	...
	protected Risque createValue() {
		return new Risque(new RisqueBean());
	}
	 ...
	 * @generated
	 */
	protected void handleDefaultCreationDate(Risque result) {
		try {
	 ...
	 * @generated
	 */
	protected void handleDefaultId(Risque result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultKey(Risque result) {
	 ...
	 * @generated
	 */
	protected void handleDefaultUpdateDate(Risque result) {
		try {
	 ...
	 * @generated
	 */
	protected void handleDefaultVersion(Risque result) {
