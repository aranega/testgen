...
//End of user code
{
	...
	@javax.persistence.OneToOne(optional = false, cascade = javax.persistence.CascadeType.ALL, mappedBy = "gaz")
	...
	/*
	 * <!-- Start of user code comment for bottletypes unsetter
	 * End of user code -->
	 */
	...
	public Element toXML(){
		Element e = new Element("Gaz");
		if (uuid != null)
			e.setAttribute(new Attribute("uuid", uuid));
		if (getName() != null)
			e.setAttribute(new Attribute("name", getName()));
		if (getWeight() != null)
			e.setAttribute(new Attribute("weight", getWeight()));
		if (getType() != null)
			e.setAttribute(new Attribute("type", getType()));
		e.setAttribute(new Attribute("density", String.valueOf(getDensity())));
		...
		if (getBottletypes() != null)
			e.setAttribute("bottletypes", String.valueOf(getBottletypes().getId()));
