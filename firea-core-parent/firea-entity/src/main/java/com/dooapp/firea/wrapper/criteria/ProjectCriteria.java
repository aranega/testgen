...
// End of user code
{
	...
	public ObjectProperty<ProjectKind> kindProperty() {
		if (kindProperty == null) {
			kindProperty = new SimpleObjectProperty<ProjectKind>(projectCriteria.getKind());
	...
	public ObjectProperty<ProjectStatus> statusProperty() {
		if (statusProperty == null) {
			statusProperty = new SimpleObjectProperty<ProjectStatus>(projectCriteria.getStatus());
