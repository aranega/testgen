...
public class PersistentImageSearchFxController implements Initializable
{
	...
	public void initialize (URL args0, ResourceBundle args1) 
	{
		...
		persistentImageCriteriaTitle.textProperty().bindBidirectional(persistentImageCriteriaWrapper.titleProperty(), new javafx.util.converter.NumberStringConverter());
		persistentImageCriteriaSourceFile.textProperty().bindBidirectional(persistentImageCriteriaWrapper.sourceFileProperty(), new javafx.util.converter.NumberStringConverter());
		persistentImageCriteriaPreview.textProperty().bindBidirectional(persistentImageCriteriaWrapper.previewProperty(), new javafx.util.converter.NumberStringConverter());
		...
		persistentImageCriteriaDataId.textProperty().bindBidirectional(persistentImageCriteriaWrapper.dataIdProperty(), new javafx.util.converter.NumberStringConverter());
