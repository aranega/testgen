...
public class ProjectEditFxController implements Initializable
{
	...
	public void initialize (URL args0, ResourceBundle args1) 
	{
		...
		projectName.textProperty().bindBidirectional(projectWrapper.nameProperty(), new javafx.util.converter.NumberStringConverter());
		projectDescription.textProperty().bindBidirectional(projectWrapper.descriptionProperty(), new javafx.util.converter.NumberStringConverter());
