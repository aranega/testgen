		...
		versionMinProperty = new SimpleIntegerProperty()
			{
				...
				public int get()
				{
					if (persistentImageCriteria.getVersionMin() != null)
						return persistentImageCriteria.getVersionMin();
					else
						return 0;
				};
		...
		versionMaxProperty = new SimpleIntegerProperty()
			{
				...
				public int get()
				{
					if (persistentImageCriteria.getVersionMax() != null)
						return persistentImageCriteria.getVersionMax();
					else
						return 0;
				};
		...
		idProperty = new SimpleLongProperty()
			{
				...
				public long get()
				{
					if (persistentImageCriteria.getId() != null)
						return persistentImageCriteria.getId();
					else
						return 0;
				};
		...
		errorProperty = new SimpleBooleanProperty()
			{
				...
				public  get()
				{
					if (persistentImageCriteria.getError() != null)
						return persistentImageCriteria.getError();
					else
						return ;
				};
