...
/**
 * This class init the DelayedTask module<br>
 * <br>
 ...
 * 
 */
public class DelayedTaskInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(DelayedTaskInitalizer.class);
