 ...
 * <br>
 * Created at : 1361291551<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class DelayedTaskController extends AbstractController<Node> {

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(DelayedTaskController.class);
	 ...
	 */
	@Inject
	protected DelayedTaskController(){}
