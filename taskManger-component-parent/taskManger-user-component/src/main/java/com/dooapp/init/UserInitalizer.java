...
/**
 * This class init the User module<br>
 * <br>
 * Created at : 1361291548<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class UserInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(UserInitalizer.class);
