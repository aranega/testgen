...
/**
 * This class init the Task module<br>
 * <br>
 * Created at : 1361291545<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class TaskInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(TaskInitalizer.class);
