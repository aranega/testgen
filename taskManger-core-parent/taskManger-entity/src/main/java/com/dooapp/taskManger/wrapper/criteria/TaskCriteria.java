...
import com.dooapp.taskManger.entity.criteria.TaskCriteriaInstance;
...
// End of user code
{
	 ...
	 * @generated
 	 */
	private TaskCriteriaInstance taskCriteria;
	 ...
	 * @generated
	 */
	public TaskCriteria(TaskCriteriaInstance entity) {
	 ...
	 * @generated
	 */
	public TaskCriteriaInstance getTaskCriteriaInstance(){
	 ...
	 * @generated
	 */
	public TaskCriteriaInstance getBean() {
		return  this.taskCriteria;
	}
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			creationDateMaxProperty = new SimpleObjectProperty<java.util.Date>(taskCriteria.getCreationDateMax());
			creationDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					taskCriteria.setCreationDateMax(arg2);
				}
			});
		}
	...
	public void setCreationDateMax(java.util.Date myCreationDateMax){
		if (creationDateMaxProperty == null) {
				taskCriteria.setCreationDateMax(myCreationDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			creationDateMinProperty = new SimpleObjectProperty<java.util.Date>(taskCriteria.getCreationDateMin());
			creationDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					taskCriteria.setCreationDateMin(arg2);
				}
			});
		}
	...
	public void setCreationDateMin(java.util.Date myCreationDateMin){
		if (creationDateMinProperty == null) {
				taskCriteria.setCreationDateMin(myCreationDateMin);
			} else {
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			this.idMaxProperty = new SimpleLongProperty(taskCriteria.getIdMax());
			this.idMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					taskCriteria.setIdMax((Long) arg2);
				}
			});
		}
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			this.idMinProperty = new SimpleLongProperty(taskCriteria.getIdMin());
			this.idMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					taskCriteria.setIdMin((Long) arg2);
				}
			});
		}
	...
	public BooleanProperty isCompletedProperty(){
		if (this.isCompletedProperty == null) {
			this.isCompletedProperty = new SimpleBooleanProperty(taskCriteria.isIsCompleted());
			this.isCompletedProperty.addListener(new ChangeListener<Boolean>() {
				@Override
				public void changed(ObservableValue<? extends Boolean> arg0, Boolean arg1, Boolean arg2) {
					taskCriteria.setIsCompleted((Boolean) arg2);
				}
			});
		}
	...
	public ObjectProperty<Priority> priorityProperty() {
		if (priorityProperty == null) {
			priorityProperty = new SimpleObjectProperty<Priority>(taskCriteria.getPriority());
	...
	public void setPriority(Priority myPriority){
		if (priorityProperty == null) {
				taskCriteria.setPriority(myPriority);
			} else {
	...
	public StringProperty titleProperty(){
		if (this.titleProperty == null) {
			this.titleProperty = new SimpleStringProperty(taskCriteria.getTitle());
			this.titleProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					taskCriteria.setTitle((String) arg2);
				}
			});
		}
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			updateDateMaxProperty = new SimpleObjectProperty<java.util.Date>(taskCriteria.getUpdateDateMax());
			updateDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					taskCriteria.setUpdateDateMax(arg2);
				}
			});
		}
	...
	public void setUpdateDateMax(java.util.Date myUpdateDateMax){
		if (updateDateMaxProperty == null) {
				taskCriteria.setUpdateDateMax(myUpdateDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			updateDateMinProperty = new SimpleObjectProperty<java.util.Date>(taskCriteria.getUpdateDateMin());
			updateDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					taskCriteria.setUpdateDateMin(arg2);
				}
			});
		}
	...
	public void setUpdateDateMin(java.util.Date myUpdateDateMin){
		if (updateDateMinProperty == null) {
				taskCriteria.setUpdateDateMin(myUpdateDateMin);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(taskCriteria.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					taskCriteria.setVersion((Integer) arg2);
				}
			});
		}
