...
import com.dooapp.taskManger.entity.criteria.UserCriteriaInstance;
...
// End of user code
{
	 ...
	 * @generated
 	 */
	private UserCriteriaInstance userCriteria;
	 ...
	 * @generated
	 */
	public UserCriteria(UserCriteriaInstance entity) {
	 ...
	 * @generated
	 */
	public UserCriteriaInstance getUserCriteriaInstance(){
	 ...
	 * @generated
	 */
	public UserCriteriaInstance getBean() {
		return  this.userCriteria;
	}
	...
	public IntegerProperty ageProperty(){
		if (this.ageProperty == null) {
			this.ageProperty = new SimpleIntegerProperty(userCriteria.getAge());
			this.ageProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					userCriteria.setAge((Integer) arg2);
				}
			});
		}
	...
	public ObjectProperty<java.util.Date> creationDateMaxProperty() {
		if (creationDateMaxProperty == null) {
			creationDateMaxProperty = new SimpleObjectProperty<java.util.Date>(userCriteria.getCreationDateMax());
			creationDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					userCriteria.setCreationDateMax(arg2);
				}
			});
		}
	...
	public void setCreationDateMax(java.util.Date myCreationDateMax){
		if (creationDateMaxProperty == null) {
				userCriteria.setCreationDateMax(myCreationDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> creationDateMinProperty() {
		if (creationDateMinProperty == null) {
			creationDateMinProperty = new SimpleObjectProperty<java.util.Date>(userCriteria.getCreationDateMin());
			creationDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					userCriteria.setCreationDateMin(arg2);
				}
			});
		}
	...
	public void setCreationDateMin(java.util.Date myCreationDateMin){
		if (creationDateMinProperty == null) {
				userCriteria.setCreationDateMin(myCreationDateMin);
			} else {
	...
	public StringProperty firstnameProperty(){
		if (this.firstnameProperty == null) {
			this.firstnameProperty = new SimpleStringProperty(userCriteria.getFirstname());
			this.firstnameProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					userCriteria.setFirstname((String) arg2);
				}
			});
		}
	...
	public LongProperty idMaxProperty(){
		if (this.idMaxProperty == null) {
			this.idMaxProperty = new SimpleLongProperty(userCriteria.getIdMax());
			this.idMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					userCriteria.setIdMax((Long) arg2);
				}
			});
		}
	...
	public LongProperty idMinProperty(){
		if (this.idMinProperty == null) {
			this.idMinProperty = new SimpleLongProperty(userCriteria.getIdMin());
			this.idMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					userCriteria.setIdMin((Long) arg2);
				}
			});
		}
	...
	public StringProperty lastnameProperty(){
		if (this.lastnameProperty == null) {
			this.lastnameProperty = new SimpleStringProperty(userCriteria.getLastname());
			this.lastnameProperty.addListener(new ChangeListener<String>() {
				@Override
				public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
					userCriteria.setLastname((String) arg2);
				}
			});
		}
	...
	public ObjectProperty<java.util.Date> updateDateMaxProperty() {
		if (updateDateMaxProperty == null) {
			updateDateMaxProperty = new SimpleObjectProperty<java.util.Date>(userCriteria.getUpdateDateMax());
			updateDateMaxProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					userCriteria.setUpdateDateMax(arg2);
				}
			});
		}
	...
	public void setUpdateDateMax(java.util.Date myUpdateDateMax){
		if (updateDateMaxProperty == null) {
				userCriteria.setUpdateDateMax(myUpdateDateMax);
			} else {
	...
	public ObjectProperty<java.util.Date> updateDateMinProperty() {
		if (updateDateMinProperty == null) {
			updateDateMinProperty = new SimpleObjectProperty<java.util.Date>(userCriteria.getUpdateDateMin());
			updateDateMinProperty.addListener(new ChangeListener<java.util.Date>() {
				@Override
				public void changed(ObservableValue<? extends java.util.Date> arg0, java.util.Date arg1, java.util.Date arg2) {
					userCriteria.setUpdateDateMin(arg2);
				}
			});
		}
	...
	public void setUpdateDateMin(java.util.Date myUpdateDateMin){
		if (updateDateMinProperty == null) {
				userCriteria.setUpdateDateMin(myUpdateDateMin);
			} else {
	...
	public IntegerProperty versionProperty(){
		if (this.versionProperty == null) {
			this.versionProperty = new SimpleIntegerProperty(userCriteria.getVersion());
			this.versionProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					userCriteria.setVersion((Integer) arg2);
				}
			});
		}
