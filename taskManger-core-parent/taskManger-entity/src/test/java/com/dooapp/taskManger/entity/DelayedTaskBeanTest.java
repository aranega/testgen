 ...
 * @generated
 */
public class DelayedTaskBeanTest
{
	/**
 	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	...
	public void setAndGetStartAt() {
		String tmp = "";
		this.bean.setStartAt(tmp);
		String result = this.bean.getStartAt();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetEndAt() {
		String tmp = "";
		this.bean.setEndAt(tmp);
		String result = this.bean.getEndAt();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	...
	/*******************
	 * Methods owned by DelayedTaskBean
	 *******************/
