...
public class DelayedTaskTest
{
	...
	public void setAndGetPriority() {
		...
		this.wrapper.setPriority(tmp);
		Priority result = this.wrapper.getPriority();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	...
	public void setAndGetIsCompleted() {
		Boolean tmp = false;
		this.wrapper.setIsCompleted(tmp);
		Boolean result = this.wrapper.isIsCompleted();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	 ...
	 */
	@Test
	public void setAndGetStartAt() {
		String tmp = "";
		this.wrapper.setStartAt(tmp);
		String result = this.wrapper.getStartAt();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	/**
	 ...
	 */
	@Test
	public void setAndGetEndAt() {
		String tmp = "";
		this.wrapper.setEndAt(tmp);
		String result = this.wrapper.getEndAt();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
	...
	public void setAndGetOwner() {
		User tmp = new User();
		this.wrapper.setOwner(tmp);
		User result = this.wrapper.getOwner();
		Assert.assertNotNull(result);
		Assert.assertEquals(tmp, result);
	}
