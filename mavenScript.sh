...
if [ ! -f dooapp-test-d-component/pom.xml ]
then
	echo "* For dooapp-test-d-component" >> ../generation.log ;
	mvn archetype:generate -B -DarchetypeGroupId=com.dooapp -DarchetypeArtifactId=component-archetype -DgroupId=com.dooapp.dooapp-test.d -DartifactId=dooapp-test-d-component -DFileShortName=D -DJavaShortName=D -Dauthor=genmymodel -Dtime="date" -DDOMAIN=D -DwrapperPackage=com.dooapp.dooapp-test.wrapper -DdomainPackage=com.dooapp.dooapp-test -DbuilderPackage=com.dooapp.dooapp-test.entity.factories  >> ../generation.log 2>>../generation.log ;
	echo "" >> ../generation.log
else
	echo "- dooapp-test-d-component/pom.xml not generated by maven because dooapp-test-d-component/pom.xml already existing" >> ../generation.log
fi;
