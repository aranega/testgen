...
public class SampleController extends AbstractController<Node> implements javafx.fxml.Initializable 
{
	...
	public void initialize(URL args0, ResourceBundle args1){
		...
		highUp_data.setText(String.valueOf(sample.getHighUp()));
		this.binder.configureBindingBidirectional(highUp_data.textProperty(), sample.highUpProperty());
