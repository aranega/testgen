...
/**
 * This class init the Contact module<br>
 * <br>
 ...
 * 
 */
public class ContactInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(ContactInitalizer.class);
