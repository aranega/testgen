...
import com.dooapp.ioc.ContactModule;
 ...
 */
@Ignore
public class ContactControllerTest extends Application {
	/**
	 * The logger
	 */
	...
	public void start(Stage arg0) throws Exception {
		...
		Scene scene = new Scene((Parent) injector.getInstance(ContactController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
