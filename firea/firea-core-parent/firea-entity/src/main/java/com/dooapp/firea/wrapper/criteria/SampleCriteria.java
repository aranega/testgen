...
public class SampleCriteria implements com.dooapp.lib.common.entity.Wrapper 
{
	...
	private IntegerProperty highUpMaxProperty;
	
	private IntegerProperty highUpMinProperty;
	...
	public IntegerProperty highUpMaxProperty(){
		if (this.highUpMaxProperty == null) {
			this.highUpMaxProperty = new SimpleIntegerProperty(sampleCriteria.getHighUpMax());
			this.highUpMaxProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					sampleCriteria.setHighUpMax((Integer) arg2);
				}
			});
			//Start of user code highUpMaxproperty method
			//End of user code
		}
		return this.highUpMaxProperty;
	}
	
	public int getHighUpMax(){
		return highUpMaxProperty().get();
	} 
	
	public void setHighUpMax(int myHighUpMax){
		this.highUpMaxProperty().set(myHighUpMax);
	}
	
	public void updateHighUpMax(final int myHighUpMax, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setHighUpMax(myHighUpMax);
			if (mutex != null) {
				mutex.notify();
			}
		} else {
	...
	public void updateHighUpMax(final int myHighUpMax) {
		updateHighUpMax(myHighUpMax, null);
	}

	public IntegerProperty highUpMinProperty(){
		if (this.highUpMinProperty == null) {
			this.highUpMinProperty = new SimpleIntegerProperty(sampleCriteria.getHighUpMin());
			this.highUpMinProperty.addListener(new ChangeListener<Number>() {
				@Override
				public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
					sampleCriteria.setHighUpMin((Integer) arg2);
				}
			});
			//Start of user code highUpMinproperty method
			//End of user code
		}
		return this.highUpMinProperty;
	}
	
	public int getHighUpMin(){
		return highUpMinProperty().get();
	} 
	
	public void setHighUpMin(int myHighUpMin){
		this.highUpMinProperty().set(myHighUpMin);
	}
	
	public void updateHighUpMin(final int myHighUpMin, final Object mutex) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setHighUpMin(myHighUpMin);
			if (mutex != null) {
				mutex.notify();
			}
		} else {
	...
	public void updateHighUpMin(final int myHighUpMin) {
		updateHighUpMin(myHighUpMin, null);
	}
