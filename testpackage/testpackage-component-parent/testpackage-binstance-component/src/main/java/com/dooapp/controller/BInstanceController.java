...
public class BInstanceController extends AbstractController<Object, Node> {
	...
	private static final Logger logger = LoggerFactory.getLogger(BInstanceController.class);
