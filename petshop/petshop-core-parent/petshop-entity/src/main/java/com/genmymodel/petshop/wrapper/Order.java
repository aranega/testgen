...
public class Order implements com.dooapp.lib.common.entity.Wrapper
{
	...
	public ObjectProperty<com.genmymodel.petshop.entity.OrderStatus> statusProperty() {
		if (statusProperty == null) {
			statusProperty = new SimpleObjectProperty<com.genmymodel.petshop.entity.OrderStatus>(order.getStatus());
