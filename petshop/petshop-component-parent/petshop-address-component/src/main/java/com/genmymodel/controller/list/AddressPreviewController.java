...
/**
 * Controller to show the Address in the list.<br>
 * <br>
 ...
 * 
 */
public class AddressPreviewController extends AbstractController<Node> implements ChildController<Address, Node>{

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(AddressPreviewController.class);
	...
	*/
	 ...
	 */
	@Inject
	protected AddressPreviewController(){}
	/**
	 * The Address we will display
	 */
	private ObjectProperty<Address> itemProperty;
	/**
	 * The Address we will display
	 */
	public ObjectProperty<Address> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<Address>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.ADDRESS.deleteHandler(getItem()).handle(null);
	}
	/**
	 * Handle when someone click to open the Address
	 */
	@FXML 
	private void open(){
		ApplicationDomain.ADDRESS.showHandler(Address.class, getItem().getId()).handle(null);
	}
