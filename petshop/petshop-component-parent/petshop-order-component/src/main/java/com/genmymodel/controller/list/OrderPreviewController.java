...
/**
 * Controller to show the Order in the list.<br>
 * <br>
 ...
 * 
 */
public class OrderPreviewController extends AbstractController<Node> implements ChildController<Order, Node>{

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(OrderPreviewController.class);
	...
	*/
	 ...
	 */
	@Inject
	protected OrderPreviewController(){}
	/**
	 * The Order we will display
	 */
	private ObjectProperty<Order> itemProperty;
	/**
	 * The Order we will display
	 */
	public ObjectProperty<Order> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<Order>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.ORDER.deleteHandler(getItem()).handle(null);
	}
	/**
	 * Handle when someone click to open the Order
	 */
	@FXML 
	private void open(){
		ApplicationDomain.ORDER.showHandler(Order.class, getItem().getId()).handle(null);
	}
