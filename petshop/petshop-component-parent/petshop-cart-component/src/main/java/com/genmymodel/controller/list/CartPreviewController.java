...
/**
 * Controller to show the Cart in the list.<br>
 * <br>
 ...
 * 
 */
public class CartPreviewController extends AbstractController<Node> implements ChildController<Cart, Node>{

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(CartPreviewController.class);
	...
	*/
	 ...
	 */
	@Inject
	protected CartPreviewController(){}
	/**
	 * The Cart we will display
	 */
	private ObjectProperty<Cart> itemProperty;
	/**
	 * The Cart we will display
	 */
	public ObjectProperty<Cart> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<Cart>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.CART.deleteHandler(getItem()).handle(null);
	}
	/**
	 * Handle when someone click to open the Cart
	 */
	@FXML 
	private void open(){
		ApplicationDomain.CART.showHandler(Cart.class, getItem().getId()).handle(null);
	}
