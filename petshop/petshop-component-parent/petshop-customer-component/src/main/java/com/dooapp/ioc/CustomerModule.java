...
public class CustomerModule extends AbstractModule {
	...
	@Context
	@Singleton
	private ObjectProperty<Customer> provideCustomerContext(ContextProvider provider) {
		return provider.provideObjectProperty();
	}
	
	/**
	 * Provide Customer list context
	 */
	@Provides
	@Context
	@Singleton
	private ObservableList<Customer> provideCustomerList(ContextProvider provider) {
