...
import com.dooapp.dooapp-test.entity.CBean;
...
// End of user code
{
	 ...
	 * @generated
	 */
	private ObjectProperty<E> eProperty;
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
	...
	public ObjectProperty<B> bProperty() {
		if (bProperty == null) {
			...
			getBean().setB(getBean().getB() == null ? null : getBean()
							.getB().getWrapper().getBean());
			bProperty.addListener(new ChangeListener<B>() {
				@Override
				public void changed(ObservableValue<? extends B> obj, B oldValue, B newValue) {
					getBean().setB(newValue == null ? null : newValue.getBean());
				}
			});
		}
		return bProperty;
	 ...
	 * @generated
	 */
	protected ObjectProperty<B> createBProperty(){
		return new SimpleObjectProperty<B>(getBean().getB() == null ? null : getBean()
							.getB().getWrapper());
	}
	...
	public void setB(B myB){
		if (bProperty == null) {
				getBean().setB(myB == null ? null : myB.getBean());
			} else {
	 ...
	 * @generated
	 */
	public void updateBAndWait(final B myB) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setB(myB);
		} else {
	 ...
	 * @generated
	 */
	public ObjectProperty<E> eProperty() {
		if (eProperty == null) {
			eProperty = createEProperty();
			getBean().setE(getBean().getE() == null ? null : getBean()
							.getE().getWrapper().getBean());
			eProperty.addListener(new ChangeListener<E>() {
				@Override
				public void changed(ObservableValue<? extends E> obj, E oldValue, E newValue) {
					getBean().setE(newValue == null ? null : newValue.getBean());
				}
			});
		}
		return eProperty;
	 ...
	 * @generated
	 */
	protected ObjectProperty<E> createEProperty(){
		return new SimpleObjectProperty<E>(getBean().getE() == null ? null : getBean()
							.getE().getWrapper());
	}
	 ...
	 * @generated
	 */
	public void setE(E myE){
		if (eProperty == null) {
				getBean().setE(myE == null ? null : myE.getBean());
			} else {
				this.eProperty().set(myE);
			}
	}
	 ...
	 * @generated
	 */
	public void updateE(final E myE) {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setE(myE);
		} else {
			javafx.application.Platform.runLater(new Runnable() {
	 ...
	 * @generated
	 */
	public void updateEAndWait(final E myE) throws InterruptedException {
		if (javafx.application.Platform.isFxApplicationThread()) {
			setE(myE);
		} else {
			final Object mutex=new Object();
