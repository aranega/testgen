...
/**
 * This class init the C module<br>
 * <br>
 ...
 * 
 */
public class CInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(CInitalizer.class);
