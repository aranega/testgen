...
/**
 * This class init the D module<br>
 * <br>
 * Created at : 1360944296<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class DInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(DInitalizer.class);
