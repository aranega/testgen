...
/**
 * This class init the BottleConfiguration module<br>
 * <br>
 * Created at : 1361190247<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class BottleConfigurationInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(BottleConfigurationInitalizer.class);
