...
import com.dooapp.firea.point.controller.list.ListPointController;
...
/**
 * This handler show list of Point <br>
 * <br>
 * Created at : date<br>
 * 
 * @author genmymodel
 ...
 * @generated
 */
public class ListPointHandler extends AbstractListHandler<Point> {
	/**
     ...
     * @generated
	 */
	private static final Logger logger = LoggerFactory.getLogger(ListPointHandler.class);
	...
	private Executor fx;
	/**
	 * The entity manager to get the list of Point
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
     *
     * @generated
	...
	/**
	 * The controller to display Point list.
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
     *
     * @generated
	 */
	@Inject
	private ListPointController itemController;
	/**
	 * The context
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 ...
	 */
	@Override
	protected List<Point> loadDataInBackground(LinkEvent<Location> event) {
		//FIXME you may not want to fetch all the database here?
		return manager.list(Point.class);
	}
	 ...
	 */
	@Override
	protected void configureContext(List<Point> arg0) {
		context.clear();
		context.addAll(arg0);
	}
	 ...
	 */
	@Override
	protected void configureLocation(List<Point> arg0, ObservableList<MenuItem> items) {
		items.clear();
		//TODO genMyModel => Add the list.Point in the application.properties files
	 ...
	 */
	@Override
	protected void toStore(List<Point> arg0, ObservableList<Wrapper> arg1) {
		// nothing to store
	}
}
