...
/**
 * Controller to show the Point in the list.<br>
 * <br>
 * Created at : date<br>
 *
 * @author genmymodel
 ...
 * @generated
 */
public class PointPreviewController extends AbstractController<Node> // Start of user code bloc for interfaces
implements ChildController<Point, Node>{
//End of user code
     ...
     * <!--  end-user-doc  -->
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(PointPreviewController.class);
	 ...
	 */
	@Inject
	protected PointPreviewController(){}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<Point> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<Point>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.POINT.deleteHandler(getItem()).handle(null);
	}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@FXML
	private void open(){
		ApplicationDomain.POINT.showHandler(Point.class, getItem().getId()).handle(null);
	}
