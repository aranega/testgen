...
/**
 * Controller to show the Gaz in the list.<br>
 * <br>
 * Created at : date<br>
 *
 * @author genmymodel
 ...
 * @generated
 */
public class GazPreviewController extends AbstractController<Node> // Start of user code bloc for interfaces
implements ChildController<Gaz, Node>{
//End of user code
     ...
     * <!--  end-user-doc  -->
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(GazPreviewController.class);
	 ...
	 */
	@Inject
	protected GazPreviewController(){}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<Gaz> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<Gaz>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.GAZ.deleteHandler(getItem()).handle(null);
	}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@FXML
	private void open(){
		ApplicationDomain.GAZ.showHandler(Gaz.class, getItem().getId()).handle(null);
	}
