...
import com.dooapp.firea.device.controller.list.ListDeviceController;
...
/**
 * This handler show list of Device <br>
 * <br>
 * Created at : date<br>
 * 
 * @author genmymodel
 ...
 * @generated
 */
public class ListDeviceHandler extends AbstractListHandler<Device> {
	/**
     ...
     * @generated
	 */
	private static final Logger logger = LoggerFactory.getLogger(ListDeviceHandler.class);
	...
	private Executor fx;
	/**
	 * The entity manager to get the list of Device
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
     *
     * @generated
	...
	/**
	 * The controller to display Device list.
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
     *
     * @generated
	 */
	@Inject
	private ListDeviceController itemController;
	/**
	 * The context
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 ...
	 */
	@Override
	protected List<Device> loadDataInBackground(LinkEvent<Location> event) {
		//FIXME you may not want to fetch all the database here?
		return manager.list(Device.class);
	}
	 ...
	 */
	@Override
	protected void configureContext(List<Device> arg0) {
		context.clear();
		context.addAll(arg0);
	}
	 ...
	 */
	@Override
	protected void configureLocation(List<Device> arg0, ObservableList<MenuItem> items) {
		items.clear();
		//TODO genMyModel => Add the list.Device in the application.properties files
	 ...
	 */
	@Override
	protected void toStore(List<Device> arg0, ObservableList<Wrapper> arg1) {
		// nothing to store
	}
}
