...
/**
 * This class init the Device module<br>
 * <br>
 ...
 * 
 */
public class DeviceInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(DeviceInitalizer.class);
