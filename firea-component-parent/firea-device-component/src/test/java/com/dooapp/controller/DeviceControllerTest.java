...
import com.dooapp.ioc.DeviceModule;
 ...
 */
@Ignore
public class DeviceControllerTest extends Application {
	/**
	 * The logger
	 */
	...
	public void start(Stage arg0) throws Exception {
		...
		Scene scene = new Scene((Parent) injector.getInstance(DeviceController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
