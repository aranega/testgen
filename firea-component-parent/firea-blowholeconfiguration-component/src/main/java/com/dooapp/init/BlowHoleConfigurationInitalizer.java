...
/**
 * This class init the BlowHoleConfiguration module<br>
 * <br>
 ...
 * 
 */
public class BlowHoleConfigurationInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(BlowHoleConfigurationInitalizer.class);
