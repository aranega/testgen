 ...
 * 
 */
public class BlowHoleConfigurationController extends AbstractController<Node> {

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(BlowHoleConfigurationController.class);
	 ...
	 */
	@Inject
	protected BlowHoleConfigurationController(){}
