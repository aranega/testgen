...
import com.dooapp.ioc.ProjectModule;
 ...
 */
@Ignore
public class ProjectControllerTest extends Application {
	/**
	 * The logger
	 */
	...
	public void start(Stage arg0) throws Exception {
		...
		Scene scene = new Scene((Parent) injector.getInstance(ProjectController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
