...
/**
 * This class init the Project module<br>
 * <br>
 ...
 * 
 */
public class ProjectInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(ProjectInitalizer.class);
