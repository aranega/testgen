 ...
 * 
 */
public class StaticStepController extends AbstractController<Node> {

	/**
	 * The famous {@link Logger}
	 */
	private static final Logger logger = LoggerFactory.getLogger(StaticStepController.class);
	 ...
	 */
	@Inject
	protected StaticStepController(){}
