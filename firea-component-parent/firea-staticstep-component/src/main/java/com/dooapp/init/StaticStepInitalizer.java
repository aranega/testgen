...
/**
 * This class init the StaticStep module<br>
 * <br>
 ...
 * 
 */
public class StaticStepInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(StaticStepInitalizer.class);
