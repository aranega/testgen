...
/**
 * This class init the BlowHoleStep module<br>
 * <br>
 ...
 * 
 */
public class BlowHoleStepInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(BlowHoleStepInitalizer.class);
