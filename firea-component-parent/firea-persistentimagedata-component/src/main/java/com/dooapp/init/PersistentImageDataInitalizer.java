...
/**
 * This class init the PersistentImageData module<br>
 * <br>
 ...
 * 
 */
public class PersistentImageDataInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(PersistentImageDataInitalizer.class);
