...
/**
 * This class init the GaugeMode module<br>
 * <br>
 * Created at : 1359124982<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class GaugeModeInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(GaugeModeInitalizer.class);
