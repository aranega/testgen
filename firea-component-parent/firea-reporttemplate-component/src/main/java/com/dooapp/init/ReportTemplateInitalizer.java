...
/**
 * This class init the ReportTemplate module<br>
 * <br>
 ...
 * 
 */
public class ReportTemplateInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(ReportTemplateInitalizer.class);
