...
public class TestedRoomControllerTest extends Application {
	...
	public void start(Stage arg0) throws Exception {
		Injector injector = Guice.createInjector(new TestedRoomModule());
		Scene scene = new Scene((Parent) injector.getInstance(TestedRoomController.class).getNode());
		arg0.setScene(scene);
		arg0.show();
	}
