...
/**
 * Controller to show the EventStep in the list.<br>
 * <br>
 * Created at : date<br>
 *
 * @author genmymodel
 ...
 * @generated
 */
public class EventStepPreviewController extends AbstractController<Node> // Start of user code bloc for interfaces
implements ChildController<EventStep, Node>{
//End of user code
     ...
     * <!--  end-user-doc  -->
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(EventStepPreviewController.class);
	...
	protected void configureView() {
		EventStep item = itemProperty.get();
		viewBinder.bind(item.dateProperty(), date, java.util.Date.class);
		viewBinder.bind(item.directionProperty(), direction, Direction.class);
	 ...
	 */
	@Inject
	protected EventStepPreviewController(){}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	...
	@Inject
		@Context
	private ObjectProperty<EventStep> itemProperty;
	/**
	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<EventStep> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<EventStep>();
		}
		return itemProperty;
	}
	/**
	 ...
	 */
	@Override
	public void setItem(EventStep item) {
	...
	@FXML
	private void delete(){
		ApplicationDomain.EVENTSTEP.deleteHandler(getItem()).handle(null);
	}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@FXML
	private void open(){
		ApplicationDomain.EVENTSTEP.showHandler(EventStep.class, getItem().getId()).handle(null);
	}
