...
import com.dooapp.firea.eventstep.controller.EventStepController;
...
/**
 * This handler show  a <br> EventStep </br>
 * <!-- begin-user-doc -->
 * <!--  end-user-doc  -->
 * @author genmymodel
 * @since 1.0-SNAPSHOT	
 * @generated
 */
public class ShowEventStepHandler extends AbstractDisplayHandler<EventStep> {
	/**
	 * The logger
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 */
	private static final Logger logger = LoggerFactory.getLogger(ShowEventStepHandler.class);
	/**
	...
	private Executor fx;
	/**
	 * The entity manager to get a fresh instance of EventStep
 	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 */
	 ...
	 */
	@Inject
	private EventStepController itemController;
	/**
	 * The context
 	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@Inject
	@Context
	private ObjectProperty<EventStep> context;
	 ...
	 */
	@Inject
	protected ShowEventStepHandler() {
	}
	 ...
	 */
	@Override
	protected Class<EventStep> getClazz() {
		return EventStep.class;
	}
	 ...
	 */
	@Override
	protected EventStep loadDataInBackground(LinkEvent<DisplayLocation> arg0) {
		try {
			return entityManager.get(EventStep.class, arg0.getLocation().getId());
	 ...
	 */
	@Override
	protected void toStore(EventStep configuration, ObservableList<Wrapper> toStore) {
	 ...
	 */
	@Override
	protected void configureLocation(final EventStep item, ObservableList<MenuItem> items) {
		items.clear();
		...
		MenuItem currentItem = MenuItemBuilder.create()
				.onAction(ApplicationDomain.EVENTSTEP.showHandler(EventStep.class, item.getId())).build();
	 ...
	 */
	@Override
	protected void configureContext(final EventStep item) {
		context.set(item);
	}
}
