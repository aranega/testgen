...
import com.dooapp.firea.folder.controller.FolderController;
...
/**
 * This handler show  a <br> Folder </br>
 * <!-- begin-user-doc -->
 * <!--  end-user-doc  -->
 * @author genmymodel
 * @since 1.0-SNAPSHOT	
 * @generated
 */
public class ShowFolderHandler extends AbstractDisplayHandler<Folder> {
	/**
	 * The logger
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 */
	private static final Logger logger = LoggerFactory.getLogger(ShowFolderHandler.class);
	/**
	...
	private Executor fx;
	/**
	 * The entity manager to get a fresh instance of Folder
 	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 */
	 ...
	 */
	@Inject
	private FolderController itemController;
	/**
	 * The context
 	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@Inject
	@Context
	private ObjectProperty<Folder> context;
	 ...
	 */
	@Override
	protected Class<Folder> getClazz() {
		return Folder.class;
	}
	 ...
	 */
	@Override
	protected Folder loadDataInBackground(LinkEvent<DisplayLocation> arg0) {
		try {
			return entityManager.get(Folder.class, arg0.getLocation().getId());
	 ...
	 */
	@Override
	protected void toStore(Folder configuration, ObservableList<Wrapper> toStore) {
	 ...
	 */
	@Override
	protected void configureLocation(final Folder item, ObservableList<MenuItem> items) {
		items.clear();
		...
		MenuItem currentItem = MenuItemBuilder.create()
				.onAction(ApplicationDomain.FOLDER.showHandler(Folder.class, item.getId())).build();
	 ...
	 */
	@Override
	protected void configureContext(final Folder item) {
		context.set(item);
	}
}
