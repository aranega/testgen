...
/**
 * This class init the Folder module<br>
 * <br>
 * Created at : 1361190260<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class FolderInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(FolderInitalizer.class);
