...
/**
 * This class init the Reading module<br>
 * <br>
 ...
 * 
 */
public class ReadingInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(ReadingInitalizer.class);
