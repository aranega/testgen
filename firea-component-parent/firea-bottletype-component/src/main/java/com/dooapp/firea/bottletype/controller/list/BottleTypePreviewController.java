...
/**
 * Controller to show the BottleType in the list.<br>
 * <br>
 * Created at : date<br>
 *
 * @author genmymodel
 ...
 * @generated
 */
public class BottleTypePreviewController extends AbstractController<Node> // Start of user code bloc for interfaces
implements ChildController<BottleType, Node>{
//End of user code
     ...
     * <!--  end-user-doc  -->
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(BottleTypePreviewController.class);
	 ...
	 */
	@Inject
	protected BottleTypePreviewController(){}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<BottleType> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<BottleType>();
		}
		return itemProperty;
	}
	/**
	 ...
	 */
	@Override
	public void setItem(BottleType item) {
	...
	@FXML
	private void delete(){
		ApplicationDomain.BOTTLETYPE.deleteHandler(getItem()).handle(null);
	}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@FXML
	private void open(){
		ApplicationDomain.BOTTLETYPE.showHandler(BottleType.class, getItem().getId()).handle(null);
	}
