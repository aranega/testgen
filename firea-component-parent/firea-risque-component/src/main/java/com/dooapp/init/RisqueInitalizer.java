...
/**
 * This class init the Risque module<br>
 * <br>
 * Created at : 1359449118<br>
 * 
 * @author genmymodel
 * @since 1.0-SNAPSHOT
 * 
 */
public class RisqueInitalizer extends Initializer {
	/**
	 * The famous logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(RisqueInitalizer.class);
