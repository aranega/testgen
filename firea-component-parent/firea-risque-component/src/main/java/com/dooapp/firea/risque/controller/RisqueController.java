package com.dooapp.firea.risque.controller;
 ...
 * @generated
 */
public class RisqueController extends AbstractController<Node>
...
//End of user code
{
    ...
    private Executor fx;
    /**
     * The Risque we will use to configure this controller
     *
     * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
     * @generated
    ...
    @Inject
    @Context
    private ObjectProperty<Risque>itemProperty;
    /**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	 * @generated
    ...
    protected void configureView() {
		Risque item = itemProperty.get();
		viewBinder.bind(item.keyProperty(), key);
	}
    /**
