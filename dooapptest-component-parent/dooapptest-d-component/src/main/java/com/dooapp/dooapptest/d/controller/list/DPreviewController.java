...
/**
 * Controller to show the D in the list.<br>
 * <br>
 * Created at : date<br>
 *
 * @author genmymodel
 ...
 * @generated
 */
public class DPreviewController extends AbstractController<Node> // Start of user code bloc for interfaces
implements ChildController<D, Node>{
//End of user code
     ...
     * <!--  end-user-doc  -->
 	 * @generated
 	 */
	private static final Logger logger = LoggerFactory.getLogger(DPreviewController.class);
	...
	protected void configureView() {
		D item = itemProperty.get();
		viewBinder.bind(item.isOkProperty(), isOk);
	}
	...
	@Inject
		@Context
	private ObjectProperty<D> itemProperty;
	/**
	 * <!-- begin-user-doc -->
 	 * <!--  end-user-doc  -->
	 * @generated
	 ...
	 * @generated
	 */
	public ObjectProperty<D> itemProperty(){
		if(itemProperty==null){
			itemProperty = new SimpleObjectProperty<D>();
		}
		return itemProperty;
	}
	/**
	...
	@FXML
	private void delete(){
		ApplicationDomain.D.deleteHandler(getItem()).handle(null);
	}
	/**
	 * <!-- begin-user-doc -->
     * <!--  end-user-doc  -->
	...
	@FXML
	private void open(){
		ApplicationDomain.D.showHandler(D.class, getItem().getId()).handle(null);
	}
